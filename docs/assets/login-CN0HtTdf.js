...
import { n as s, t as c } from "./chromium-DtSZUd0H.js";
import { t as l } from "./arrow-right-BmTjqXc8.js";
import { t as u } from "./circle-alert-3YAmvEKb.js";
import { t as d } from "./circle-check-ZudQV6YN.js";
import { t as f } from "./eye-off-BxEj3xAJ.js";
import { t as p } from "./eye-c82Dcalm.js";
import { t as m } from "./shield-check-D_i7EwFT.js";
import { i as h } from "./index-C7L7o5NO.js";
var g = t(e()),
  _ = n();
function v() {
  let e = i(),
    { login: t, failedLoginAttempts: n, captchaRequired: v, resetFailedAttempts: y } = a(),
    [b, x] = (0, g.useState)(``),
    [S, C] = (0, g.useState)(``),
    [w, T] = (0, g.useState)(!1),
    [E, D] = (0, g.useState)(!1),
    ...
    [I, L] = (0, g.useState)(!1);
  (0, g.useEffect)(() => {
    let e = localStorage.getItem(`tbb_remembered_email`);
    e && (x(e), D(!0));
  }, []);
  let R = (e) => {
    ...
    z = async (n) => {
      if ((n.preventDefault(), N(``), v && !I)) {
        N(`Please slide the golden lock to verify your identity.`);
        return;
      }
      k(!0);
      try {
        ...
        n.success
          ? (j(!0),
            E
              ? localStorage.setItem(`tbb_remembered_email`, b)
              : localStorage.removeItem(`tbb_remembered_email`),
            setTimeout(() => {
              n.role === `superadmin`
                ? e({ to: `/superadmin/dashboard` })
                : n.role === `admin`
                  ? e({ to: `/admin/dashboard` })
                  : e({ to: `/dashboard` });
            }, 1500))
          : (N(n.error || `Invalid credentials.`), F(0), L(!1));
      } catch {
        N(`An unexpected connection error occurred. Please try again.`);
      } finally {
        k(!1);
      }
    },
    B = (e) => {
      (k(!0),
        ...
        setTimeout(() => {
          (k(!1), j(!0));
          let t = localStorage.getItem(`naa-users-db`),
            n = t ? JSON.parse(t) : [],
            r = n.find((t) => t.email === `social_${e.toLowerCase()}@belvoma.com`);
          (r ||
            ((r = {
              name: `Guest ${e} User`,
              email: `${e.toLowerCase()}_client@belvoma.com`,
              phone: `+233240000000`,
              role: `user`,
              createdAt: new Date().toISOString(),
            }),
            n.push(r),
            localStorage.setItem(`naa-users-db`, JSON.stringify(n))),
  ...
  return (0, _.jsxs)(`div`, {
    ...
    children: [
      (0, _.jsx)(`div`, {
        className: `absolute top-[-10%] right-[-10%] w-[40vw] h-[40vw] rounded-full bg-gold/5 blur-[120px] pointer-events-none`,
      }),
      (0, _.jsx)(`div`, {
        className: `absolute bottom-[-15%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-gold/5 blur-[140px] pointer-events-none`,
      }),
      (0, _.jsxs)(o.div, {
          ...
          (0, _.jsx)(h, {
            children:
              ...
              (0, _.jsxs)(o.div, {
                ...
                children: [
                  (0, _.jsx)(u, { className: `h-5 w-5 text-destructive shrink-0 mt-0.5` }),
                  (0, _.jsx)(`span`, {
              ...
              (0, _.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, _.jsx)(`button`, {
                    ...
                    children: w
                      ? (0, _.jsx)(f, { className: `h-4 w-4` })
                      : (0, _.jsx)(p, { className: `h-4 w-4` }),
                  }),
                ],
              }),
              (0, _.jsxs)(`div`, {
                    ...
                    (0, _.jsxs)(`div`, {
                      ...
                      children: [
                        (0, _.jsxs)(`span`, {
                          ...
                          children: [
                            (0, _.jsx)(m, { className: `h-4 w-4 text-gold` }),
                            ` Golden Verification`,
                          ],
                        }),
                        (0, _.jsx)(`span`, {
                          className: `text-[10px] text-muted-foreground uppercase tracking-widest`,
                          children: I ? `Verified` : `Slide to Unlock`,
                        }),
                      ],
                    }),
                    (0, _.jsxs)(`div`, {
                      ...
                      children: [
                        (0, _.jsx)(`input`, {
                          ...
                          disabled: I,
                          onChange: R,
                          className: `w-full h-full opacity-0 absolute inset-0 cursor-pointer z-10 ${I ? `pointer-events-none` : ``}`,
                        }),
                        (0, _.jsx)(o.div, {
                          animate: { x: `${P * 3.2}%` },
                          className: `h-8 w-8 rounded-md flex items-center justify-center transition-colors shadow-soft ${I ? `bg-gold text-white` : `bg-gradient-to-br from-gold to-gold-light text-white`}`,
                          children: (0, _.jsx)(l, {
                            className: `h-4 w-4 transition-transform ${I ? `rotate-90` : ``}`,
                          }),
                        }),
                        (0, _.jsx)(`span`, {
                          className: `text-[11px] font-light mx-auto select-none pointer-events-none transition-opacity ${P > 15 ? `opacity-20` : `opacity-70`}`,
                          children: I ? `Identity Verified ✨` : `Slide Gold Bar to Right`,
                        }),
                      ],
                    }),
                  ],
          ...
          (0, _.jsxs)(`div`, {
            ...
            children: [
              (0, _.jsx)(`div`, {
                ...
                "aria-hidden": `true`,
                children: (0, _.jsx)(`div`, { className: `w-full border-t border-border` }),
              }),
              (0, _.jsx)(`div`, {
          ...
          (0, _.jsxs)(`div`, {
            ...
            children: [
              (0, _.jsxs)(`button`, {
                ...
                children: [
                  (0, _.jsx)(c, { className: `h-4 w-4 text-muted-foreground` }),
                  ` Google`,
                ],
              }),
              (0, _.jsxs)(`button`, {
                ...
                onClick: () => B(`Apple`),
                className: `flex items-center justify-center gap-2 py-3 border border-border rounded-xl hover:border-gold/30 hover:bg-accent/10 transition-all font-sans text-xs text-foreground bg-transparent`,
                children: [(0, _.jsx)(s, { className: `h-4 w-4 text-muted-foreground` }), ` Apple`],
              }),
            ],
          }),
          (0, _.jsxs)(`div`, {
