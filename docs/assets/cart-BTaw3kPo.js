...
import { t as o } from "./minus-BbksUQKY.js";
import { t as s } from "./plus-DK9MZKQp.js";
import { t as c } from "./tag-UFC9nek1.js";
import { t as l } from "./trash-2-CNqhW4qt.js";
import { a as u, n as d } from "./products-pUvZdLaj.js";
import { c as f } from "./index-BLNfkPy1.js";
var p = t(e()),
  m = n();
function h() {
  let { cart: e, setQty: t, removeFromCart: n } = i(),
    [h, g] = (0, p.useState)(``),
    [_, v] = (0, p.useState)(!1),
    [y, b] = (0, p.useState)(!1),
    x = e.map((e) => ({ ...e, product: u(e.productId) })).filter((e) => e.product),
    S = x.reduce((e, t) => e + t.product.price * t.qty, 0),
    C = _ ? S * 0.1 : 0,
    w = S - C >= 75 || x.length === 0 ? 0 : 6.95,
    T = S - C + w;
  return (0, m.jsxs)(`div`, {
    ...
    children: [
      ...
      x.length === 0
        ? (0, m.jsxs)(`div`, {
            ...
            children: [
              (0, m.jsx)(f, { className: `mx-auto h-12 w-12 text-muted-foreground/40` }),
              (0, m.jsx)(`p`, {
        ...
        : (0, m.jsxs)(`div`, {
            ...
            children: [
              (0, m.jsx)(`ul`, {
                ...
                children: x.map(({ product: e, qty: i }) =>
                  (0, m.jsxs)(
                    a.li,
                    {
                      layout: !0,
                                ...
                                (0, m.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, m.jsxs)(`p`, {
                                      ...
                                      children: [e.category, ` · `, e.material],
                                    }),
                                  ],
                                }),
                                (0, m.jsx)(`button`, {
                                ...
                                (0, m.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, m.jsx)(`button`, {
                                      ...
                                      children: (0, m.jsx)(o, { className: `h-3.5 w-3.5` }),
                                    }),
                                    (0, m.jsx)(`span`, {
                                    ...
                                    (0, m.jsx)(`button`, {
                                      ...
                                      className: `grid h-9 w-9 place-items-center hover:text-gold`,
                                      children: (0, m.jsx)(s, { className: `h-3.5 w-3.5` }),
                                    }),
                                  ],
                                }),
                                (0, m.jsx)(`p`, {
                                  className: `font-semibold`,
                                  children: d(e.price * i),
                                }),
                              ],
                            }),
                          ],
                    ...
                    children: [
                      (0, m.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, m.jsx)(`dd`, { className: `font-medium`, children: d(S) }),
                        ],
                      }),
                      _ &&
                        (0, m.jsxs)(`div`, {
                          ...
                          children: [
                            (0, m.jsx)(`dt`, { children: `Promo (NAA10 −10%)` }),
                            (0, m.jsxs)(`dd`, { children: [`−`, d(C)] }),
                          ],
                        }),
                      (0, m.jsxs)(`div`, {
                        className: `flex justify-between`,
                      ...
                      (0, m.jsxs)(`div`, {
                        ...
                        children: [
                          (0, m.jsx)(`dt`, { children: `Total` }),
                          (0, m.jsx)(`dd`, { children: d(T) }),
                        ],
                      }),
                    ],
                  }),
                      ...
                      children: [
                        ...
                        (0, m.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, m.jsxs)(`button`, {
                              onClick: () => {
                                h.trim().toUpperCase() === `NAA10` ? (v(!0), b(!1)) : b(!0);
                              },
                              ...
                              children: [(0, m.jsx)(c, { className: `h-3.5 w-3.5` }), ` Apply`],
                            }),
                          ],
                        }),
                        y &&
