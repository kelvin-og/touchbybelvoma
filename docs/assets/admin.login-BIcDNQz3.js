...
import { t as s } from "./arrow-right-BmTjqXc8.js";
import { t as c } from "./circle-alert-3YAmvEKb.js";
import { t as l } from "./eye-off-BxEj3xAJ.js";
import { t as u } from "./eye-c82Dcalm.js";
import { t as d } from "./lock-zNDHqqRP.js";
import { t as f } from "./shield-check-D_i7EwFT.js";
import { i as p } from "./index-C7L7o5NO.js";
var m = t(e()),
  h = n();
function g() {
  let e = i(),
  ...
  return (0, h.jsxs)(`div`, {
    ...
    children: [
      (0, h.jsx)(`div`, {
        className: `absolute top-[-20%] left-[-20%] w-[60vw] h-[60vw] rounded-full bg-gold/5 blur-[150px] pointer-events-none`,
      }),
      (0, h.jsx)(`div`, {
        className: `absolute bottom-[-20%] right-[-20%] w-[60vw] h-[60vw] rounded-full bg-gold/5 blur-[150px] pointer-events-none`,
      }),
      (0, h.jsx)(`div`, {
        ...
        children: [
          ...
          (0, h.jsxs)(`div`, {
            ...
            children: [
              (0, h.jsx)(`div`, {
                ...
                children: (0, h.jsx)(d, { className: `h-5 w-5` }),
              }),
              (0, h.jsx)(`h2`, {
          ...
          T &&
            (0, h.jsxs)(`div`, {
              ...
              children: [
                (0, h.jsx)(c, { className: `h-5 w-5 text-destructive shrink-0 mt-0.5` }),
                (0, h.jsx)(`span`, {
          ...
          (0, h.jsxs)(`form`, {
            onSubmit: async (r) => {
              ...
              try {
                let r = await t(n, _, `admin`);
                r.success
                  ? (w(!0),
                    setTimeout(() => {
                      e({ to: `/admin/dashboard` });
                    }, 1500))
                  : E(r.error || `Access Denied: Invalid administrator credentials.`);
              } catch {
                E(`Security connection timeout. Please check your credentials.`);
              } finally {
                S(!1);
              }
            },
              ...
              (0, h.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, h.jsx)(`button`, {
                    ...
                    children: y
                      ? (0, h.jsx)(l, { className: `h-4 w-4` })
                      : (0, h.jsx)(u, { className: `h-4 w-4` }),
                  }),
                ],
              }),
              (0, h.jsx)(`button`, {
                ...
                children: x
                  ...
                  : (0, h.jsxs)(h.Fragment, {
                      children: [`Unlock Portal `, (0, h.jsx)(s, { className: `h-3.5 w-3.5` })],
                    }),
              }),
            ],
          }),
