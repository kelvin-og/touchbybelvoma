...
import { t as o } from "./eye-c82Dcalm.js";
import { t as s } from "./star-vwdllOWM.js";
import { n as c } from "./products-pUvZdLaj.js";
import { a as l, c as u, d, i as f } from "./index-BLNfkPy1.js";
var p = t(e(), 1),
  m = n();
function h({ product: e, index: t = 0 }) {
  let { addToCart: n, toggleWishlist: h, isWishlisted: g } = i(),
    [_, v] = (0, p.useState)(!1),
    y = g(e.id);
  return (0, m.jsxs)(m.Fragment, {
    children: [
      (0, m.jsxs)(a.article, {
        ...
        transition: { duration: 0.55, delay: (t % 4) * 0.08, ease: [0.22, 1, 0.36, 1] },
        ...
        children: [
          (0, m.jsx)(r, {
            ...
            children: (0, m.jsxs)(`div`, {
              ...
              children: [
                ...
                (e.isNew || e.isBestSeller || e.originalPrice) &&
                  (0, m.jsx)(`span`, {
                    ...
                    children: e.originalPrice
                      ? (0, m.jsx)(`span`, { className: `text-destructive`, children: `Sale` })
                      : e.isNew
                        ? (0, m.jsx)(`span`, { className: `text-gold`, children: `New` })
                        : `Best Seller`,
                  }),
              ],
            }),
          ...
          (0, m.jsx)(`button`, {
            "aria-label": y ? `Remove from wishlist` : `Add to wishlist`,
            onClick: () => h(e.id),
            className: `absolute top-3 right-3 grid h-9 w-9 place-items-center rounded-full bg-card/90 shadow-soft backdrop-blur-sm transition-all hover:scale-110 ${y ? `text-gold` : `text-foreground`}`,
            children: (0, m.jsx)(d, { className: `h-4 w-4 ${y ? `fill-current` : ``}` }),
          }),
          (0, m.jsxs)(`div`, {
            ...
            children: [
              (0, m.jsxs)(`button`, {
                ...
                children: [(0, m.jsx)(o, { className: `h-3.5 w-3.5` }), ` Quick View`],
              }),
              (0, m.jsxs)(`button`, {
                onClick: () => n(e.id),
                ...
                children: [(0, m.jsx)(u, { className: `h-3.5 w-3.5` }), ` Add`],
              }),
            ],
          }),
          (0, m.jsxs)(`div`, {
            ...
            children: [
              (0, m.jsxs)(`div`, {
                ...
                children: [
                  (0, m.jsx)(s, { className: `h-3.5 w-3.5 fill-current` }),
                  (0, m.jsx)(`span`, { className: `text-xs font-medium`, children: e.rating }),
                  (0, m.jsxs)(`span`, {
              ...
              (0, m.jsxs)(`div`, {
                ...
                children: [
                  (0, m.jsx)(`span`, { className: `text-sm font-semibold`, children: c(e.price) }),
                  e.originalPrice &&
                    (0, m.jsx)(`span`, {
                      className: `text-xs text-muted-foreground line-through`,
                      children: c(e.originalPrice),
                    }),
                ],
              }),
            ],
              ...
              children: [
                ...
                (0, m.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, m.jsx)(`p`, { className: `eyebrow`, children: e.category }),
                    (0, m.jsx)(`h3`, { className: `mt-1 text-xl font-semibold`, children: e.name }),
                    (0, m.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, m.jsxs)(`span`, {
                          className: `text-xs text-muted-foreground`,
                          children: [`(`, e.reviewCount, ` reviews)`],
                        }),
                      ],
                    }),
                    (0, m.jsx)(`p`, {
                    ...
                    (0, m.jsxs)(`button`, {
                      ...
                      children: [(0, m.jsx)(u, { className: `h-4 w-4` }), ` Add to Cart`],
                    }),
                  ],
                }),
              ],
