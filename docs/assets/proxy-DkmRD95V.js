import { a as e, i as t, n, o as r, s as i, t as a } from "./jsx-runtime-D8nDyRPw.js";
var o = i(n()),
  s = (...e) =>
    e
...
var v = typeof window < `u` ? o.useLayoutEffect : o.useEffect,
...
var T = (e) => e,
  ...
  D = (e) => e / 1e3,
  se = (e, t) => (t ? (1e3 / t) * e : 0),
  ce = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e,
  le = 1e-7,
  ue = 12;
function de(e, t, n, r, i) {
  let a,
    o,
    s = 0;
  do ((o = t + (n - t) / 2), (a = ce(o, r, i) - e), a > 0 ? (n = o) : (t = o));
  while (Math.abs(a) > le && ++s < ue);
  return o;
}
function fe(e, t, n, r) {
  if (e === t && n === r) return T;
  let i = (t) => de(t, 0, 1, e, n);
  return (e) => (e === 0 || e === 1 ? e : ce(i(e), t, r));
}
var pe = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2),
  me = (e) => (t) => 1 - e(1 - t),
  he = fe(0.33, 1.53, 0.69, 0.99),
  ge = me(he),
  _e = pe(ge),
  ve = (e) => (e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * ge(e) : 0.5 * (2 - 2 ** (-10 * (e - 1)))),
  ye = (e) => 1 - Math.sin(Math.acos(e)),
  be = me(ye),
  xe = pe(ye),
  Se = fe(0.42, 0, 1, 1),
  Ce = fe(0, 0, 0.58, 1),
  ...
  ke = (e) => {
    if (Ee(e)) {
      ...
      let [t, n, r, i] = e;
      return fe(t, n, r, i);
    } else if (Oe(e)) return (De[e], `${e}`, De[e]);
    return e;
  },
  Ae = [
    `setup`,
...
function Ne(e, t) {
  let n = !1,
    ...
    h = () => {
      let a = w.useManualTiming,
        o = a ? i.timestamp : performance.now();
      ((n = !1),
        a || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, Me), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
  ...
  return {
    schedule: Ae.reduce((e, t) => {
      let r = o[t];
      return ((e[t] = (e, t = !1, i = !1) => (n || g(), r.schedule(e, t, i))), e);
    }, {}),
    cancel: (e) => {
      for (let t = 0; t < Ae.length; t++) o[Ae[t]].cancel(e);
    },
    state: i,
    steps: o,
  };
...
var {
    ...
    state: A,
    steps: Pe,
  } = Ne(typeof requestAnimationFrame < `u` ? requestAnimationFrame : T, !0),
  Fe;
function Ie() {
  Fe = void 0;
}
var j = {
    now: () => (
      Fe === void 0 && j.set(A.isProcessing || w.useManualTiming ? A.timestamp : performance.now()),
      Fe
    ),
    set: (e) => {
      ((Fe = e), queueMicrotask(Ie));
    },
  },
  Le = (e) => (t) => typeof t == `string` && t.startsWith(e),
  Re = Le(`--`),
  ze = Le(`var(--`),
  Be = (e) => (ze(e) ? Ve.test(e.split(`/*`)[0].trim()) : !1),
  Ve = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
function He(e) {
  return typeof e == `string` && e.split(`/*`)[0].includes(`var(--`);
}
var Ue = { test: (e) => typeof e == `number`, parse: parseFloat, transform: (e) => e },
  We = { ...Ue, transform: (e) => S(0, 1, e) },
  Ge = { ...Ue, default: 1 },
  Ke = (e) => Math.round(e * 1e5) / 1e5,
  qe = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;
function Je(e) {
  return e == null;
}
var Ye =
  ...
  Xe = (e, t) => (n) =>
    !!(
      (typeof n == `string` && Ye.test(n) && n.startsWith(e)) ||
      (t && !Je(n) && Object.prototype.hasOwnProperty.call(n, t))
    ),
  Ze = (e, t, n) => (r) => {
  ...
  Qe = (e) => S(0, 255, e),
  $e = { ...Ue, transform: (e) => Math.round(Qe(e)) },
  M = {
    test: Xe(`rgb`, `red`),
...
var tt = { test: Xe(`#`), parse: et, transform: M.transform },
  nt = (e) => ({
  ...
  rt = nt(`vh`),
  it = nt(`vw`),
  at = { ...P, parse: (e) => P.parse(e) / 100, transform: (e) => P.transform(e * 100) },
  ot = {
    test: Xe(`hsl`, `hue`),
  ...
  I = {
    test: (e) => M.test(e) || tt.test(e) || ot.test(e),
    parse: (e) => (M.test(e) ? M.parse(e) : ot.test(e) ? ot.parse(e) : tt.parse(e)),
    transform: (e) =>
      typeof e == `string` ? e : e.hasOwnProperty(`red`) ? M.transform(e) : ot.transform(e),
    getAnimatableNone: (e) => {
      let t = I.parse(e);
...
function ct(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(qe)?.length || 0) + (e.match(st)?.length || 0) > 0
  );
}
var lt = `number`,
  ut = `color`,
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          I.test(e)
            ? (r.color.push(a), i.push(ut), n.push(I.parse(e)))
            : e.startsWith(ft)
...
function _t({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === lt ? (i += Ke(r[a])) : e === ut ? (i += I.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
var yt = (e) => (typeof e == `number` ? 0 : I.test(e) ? I.getAnimatableNone(e) : e),
  bt = (e, t) => (typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : yt(e));
function xt(e) {
  let t = ht(e);
  return _t(t)(t.values.map((e, n) => bt(e, t.split[n])));
}
var L = { test: ct, parse: gt, createTransformer: vt, getAnimatableNone: xt };
function St(e, t, n) {
  return (
    n < 0 && (n += 1),
    n > 1 && --n,
...
function Ct({ hue: e, saturation: t, lightness: n, alpha: r }) {
  ...
  if (!t) i = a = o = n;
    ...
    let r = n < 0.5 ? n * (1 + t) : n + t - n * t,
      s = 2 * n - r;
    ((i = St(s, r, e + 1 / 3)), (a = St(s, r, e)), (o = St(s, r, e - 1 / 3)));
  }
  return {
...
var R = (e, t, n) => e + (t - e) * n,
  ...
  Et = [tt, M, ot],
  Dt = (e) => Et.find((t) => t.test(e));
function Ot(e) {
  let t = Dt(e);
  if ((`${e}`, !t)) return !1;
  let n = t.parse(e);
  return (t === ot && (n = Ct(n)), n);
}
var kt = (e, t) => {
    let n = Ot(e),
      r = Ot(t);
    ...
    let i = { ...n };
    return (e) => (
      (i.red = Tt(n.red, r.red, e)),
      (i.green = Tt(n.green, r.green, e)),
      (i.blue = Tt(n.blue, r.blue, e)),
      (i.alpha = R(n.alpha, r.alpha, e)),
      M.transform(i)
    );
  },
  At = new Set([`none`, `hidden`]);
function jt(e, t) {
  return At.has(e) ? (n) => (n <= 0 ? e : t) : (n) => (n >= 1 ? t : e);
}
function Mt(e, t) {
  return (n) => R(e, t, n);
}
...
var Lt = (e, t) => {
  let n = L.createTransformer(t),
    r = ht(e),
    i = ht(t);
  return r.indexes.var.length === i.indexes.var.length &&
    r.indexes.color.length === i.indexes.color.length &&
    r.indexes.number.length >= i.indexes.number.length
    ? (At.has(e) && !i.values.length) || (At.has(t) && !r.values.length)
      ? jt(e, t)
      : ie(Pt(It(r, i), i.values), n)
    : (`${e}${t}`, wt(e, t));
};
function Rt(e, t, n) {
...
function Jt({
  ...
  z.maxDuration;
  let o = 1 - t;
  ((o = S(z.minDamping, z.maxDamping, o)),
    (e = S(z.minDuration, z.maxDuration, D(e))),
    o < 1
      ? ((i = (t) => {
          let r = t * o,
            i = r * e,
  ...
  let s = 5 / e,
    c = Kt(i, a, s);
  if (((e = E(e)), isNaN(c))) return { stiffness: z.stiffness, damping: z.damping, duration: e };
  {
    let t = c ** 2 * r;
  ...
  if (!Zt(e, Xt) && Zt(e, Yt))
    if (((t.velocity = 0), e.visualDuration)) {
      let n = e.visualDuration,
        r = (2 * Math.PI) / (n * 1.2),
        i = r * r,
        a = 2 * S(0.05, 1, 1 - (e.bounce || 0)) * Math.sqrt(i);
      t = { ...t, mass: z.mass, stiffness: i, damping: a };
    } else {
      let n = Jt({ ...e, velocity: 0 });
      ((t = { ...t, ...n, mass: z.mass }), (t.isResolvedFromDuration = !0));
    }
  return t;
}
function $t(e = z.visualDuration, t = z.bounce) {
  let n = typeof e == `object` ? e : { visualDuration: e, keyframes: [0, 1], bounce: t },
    ...
    } = Qt({ ...n, velocity: -D(n.velocity || 0) }),
    m = f || 0,
    h = l / (2 * Math.sqrt(c * u)),
    g = o - a,
    _ = D(Math.sqrt(c / u)),
    v = Math.abs(g) < 5;
  ((r ||= v ? z.restSpeed.granular : z.restSpeed.default),
    (i ||= v ? z.restDelta.granular : z.restDelta.default));
  let y, b, x, S, C, w;
  if (h < 1)
    ((x = Wt(_, h)),
      (S = (m + h * _ * g) / x),
  ...
  let ee = {
    ...
    toString: () => {
      let e = Math.min(Ht(ee), Vt),
        t = Bt((t) => ee.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
$t.applyToOptions = (e) => {
  let t = Ut(e, 100, $t);
  return ((e.ease = t.ease), (e.duration = E(t.duration)), (e.type = `keyframes`), e);
};
var en = 5;
function tn(e, t, n) {
...
function rn(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = ie(Array.isArray(t) ? t[n] || T : t, a)), r.push(a));
  }
  return r;
}
function an(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
  ...
  let s = rn(t, r, i),
    ...
    l = (n) => {
      ...
      let i = ae(e[r], e[r + 1], n);
      return s[r](i);
    };
  return n ? (t) => l(S(e[0], e[a - 1], t)) : l;
}
function on(e, t) {
  let n = e[e.length - 1];
  for (let r = 1; r <= t; r++) {
...
function un({ duration: e = 300, keyframes: t, times: n, ease: r = `easeInOut` }) {
  let i = Te(r) ? r.map(ke) : ke(r),
    a = { done: !1, value: t[0] },
    o = an(cn(n && n.length === t.length ? n : sn(t), e), t, {
      ease: Array.isArray(i) ? i : ln(t, i),
    });
  return { calculatedDuration: e, next: (t) => ((a.value = o(t)), (a.done = t >= e), a) };
}
var dn = (e) => e !== null;
function fn(e, { repeat: t, repeatType: n = `loop` }, r, i = 1) {
  let a = e.filter(dn),
    o = i < 0 || (t && n !== `loop` && t % 2 == 1) ? 0 : a.length - 1;
  return !o || r === void 0 ? a[o] : r;
}
var pn = { decay: nn, inertia: nn, tween: un, keyframes: un, spring: $t };
function mn(e) {
  typeof e.type == `string` && (e.type = pn[e.type]);
}
var hn = class {
    constructor() {
      this.updateFinished();
  ...
  _n = class extends hn {
    constructor(e) {
      (super(),
        ...
        (this.stop = () => {
          ...
          (e && e.updatedAt !== j.now() && this.tick(j.now()),
            (this.isStopped = !0),
    ...
    initAnimation() {
      let { options: e } = this;
      mn(e);
      let { type: t = un, repeat: n = 0, repeatDelay: r = 0, repeatType: i, velocity: a = 0 } = e,
        { keyframes: o } = e,
        s = t || un;
      s !== un &&
        typeof o[0] != `number` &&
        ((this.mixKeyframes = ie(gn, Rt(o[0], o[1]))), (o = [0, 100]));
      let c = s({ ...e, keyframes: o });
      (i === `mirror` &&
        (this.mirroredGenerator = s({ ...e, keyframes: [...o].reverse(), velocity: -a })),
        c.calculatedDuration === null && (c.calculatedDuration = Ht(c)));
    ...
    tick(e, t = !1) {
      ...
      return (
        C && p !== nn && (b.value = fn(l, this.options, h, this.speed)),
        m && m(b.value),
        C && this.finish(),
        b
      );
    ...
    set speed(e) {
      ...
      (t && this.driver && this.updateTime(j.now()),
        (this.playbackSpeed = e),
        t && this.driver && (this.time = D(this.currentTime)));
    }
    play() {
      if (this.isStopped) return;
      let { driver: e = zt, startTime: t } = this.options;
...
var B = (e) => (e * 180) / Math.PI,
  yn = (e) => xn(B(Math.atan2(e[1], e[0]))),
  bn = {
    x: 4,
    y: 5,
    translateX: 4,
    ...
    rotate: yn,
    rotateZ: yn,
    skewX: (e) => B(Math.atan(e[1])),
    skewY: (e) => B(Math.atan(e[2])),
    skew: (e) => (Math.abs(e[1]) + Math.abs(e[2])) / 2,
  },
  xn = (e) => ((e %= 360), e < 0 && (e += 360), e),
  Sn = yn,
  Cn = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]),
  wn = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]),
  Tn = {
    x: 12,
    y: 13,
    z: 14,
    ...
    scaleY: wn,
    scale: (e) => (Cn(e) + wn(e)) / 2,
    rotateX: (e) => xn(B(Math.atan2(e[6], e[5]))),
    rotateY: (e) => xn(B(Math.atan2(-e[2], e[0]))),
    rotateZ: Sn,
    rotate: Sn,
    skewX: (e) => B(Math.atan(e[4])),
    skewY: (e) => B(Math.atan(e[1])),
...
var An = [
  ...
  jn = new Set([...An, `pathRotation`]),
  Mn = (e) => e === Ue || e === F,
  Nn = new Set([`x`, `y`, `z`]),
  Pn = An.filter((e) => !Nn.has(e));
function Fn(e) {
  let t = [];
  return (
    Pn.forEach((n) => {
...
var Un = class {
    ...
    scheduleResolve() {
      ((this.state = `scheduled`),
        this.isAsync
          ? (In.add(this), Ln || ((Ln = !0), O.read(Vn), O.resolveKeyframes(Bn)))
...
var Jn = qn(() => window.ScrollTimeline !== void 0, `scrollTimeline`),
  Yn = qn(() => window.ViewTimeline !== void 0, `viewTimeline`),
  Xn = qn(() => {
    try {
...
function nr({ type: e, ...t }) {
  return tr(e) && Xn() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
var rr = class extends hn {
    constructor(e) {
      ...
      let c = nr(e);
      ((this.animation = er(t, n, r, c, i)),
        c.autoplay === !1 && this.animation.pause(),
        (this.animation.onfinish = () => {
          if (((this.finishedTime = this.time), !i)) {
            let e = fn(r, this.options, o, this.speed);
  ...
  ir = { anticipate: ve, backInOut: _e, circInOut: xe };
function ar(e) {
  return e in ir;
}
function or(e) {
  typeof e.ease == `string` && ar(e.ease) && (e.ease = ir[e.ease]);
}
var sr = 10,
  cr = class extends rr {
    constructor(e) {
    ...
    updateMotionValue(e) {
      ...
      let o = new _n({ ...a, autoplay: !1 }),
        s = Math.max(sr, j.now() - this.startTime),
        c = S(0, sr, s - sr),
        l = o.sample(s).value,
        { name: u } = this.options;
      (i && u && Gn(i, u, l),
  ...
  lr = (e, t) =>
    ...
    !!(
      typeof e == `number` ||
      Array.isArray(e) ||
      (typeof e == `string` && (L.test(e) || e === `0`) && !e.startsWith(`url(`))
    );
function ur(e) {
  let t = e[0];
...
function dr(e, t, n, r) {
  ...
  let a = e[e.length - 1],
    o = lr(i, t),
    s = lr(a, t);
  return (`${t}${i}${a}${o ? a : i}`, !o || !s ? !1 : ur(e) || ((n === `spring` || tr(n)) && r));
}
function fr(e) {
  ((e.duration = 0), (e.type = `keyframes`));
}
var pr = new Set([`opacity`, `clipPath`, `filter`, `transform`]),
...
var gr = new Set([
  ...
  _r = re(() => Object.hasOwnProperty.call(Element.prototype, `animate`));
function vr(e) {
  let {
    motionValue: t,
    name: n,
...
var yr = 40,
  br = class extends hn {
    ...
    onKeyframesResolved(e, t, n, r) {
      ...
      dr(e, i, a, o) ||
        ((u = !1),
        (w.instantAnimations || !s) && l?.(fn(e, n, t)),
        (e[0] = e[e.length - 1]),
        fr(n),
        (n.repeat = 0));
      let d = {
          startTime: r
            ? this.resolvedAt && this.resolvedAt - this.createdAt > yr
              ? this.resolvedAt
              : this.createdAt
            : void 0,
          finalKeyframe: t,
    ...
    get animation() {
      return (this._animation || (this.keyframeResolver?.resume(), Hn()), this._animation);
    }
    get duration() {
...
var Sr = 30,
  ...
  Tr = class {
    ...
    getVelocity() {
      ...
      return se(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
    }
    start(e) {
      return (
        this.stop(),
...
var Or = { type: `spring`, stiffness: 500, damping: 25, restSpeed: 10 },
  ...
  Mr = (e, { keyframes: t }) =>
    t.length > 2 ? Ar : jn.has(e) ? (e.startsWith(`scale`) ? kr(t[1]) : Or) : jr,
  Nr = new Set([
    `when`,
    `delay`,
    `delayChildren`,
    ...
    (o) => {
      ...
      if (
        ((u.type === !1 || (u.duration === 0 && !u.repeatDelay)) &&
          (fr(u), u.delay === 0 && (d = !0)),
        (w.instantAnimations || w.skipAnimations || i?.shouldSkipAnimations || s.skipAnimations) &&
          ((d = !0), fr(u), (u.delay = 0)),
        (u.allowFlatten = !s.type && !s.ease),
        d && !a && t.get() !== void 0)
      ) {
        let e = fn(u.keyframes, s);
        if (e !== void 0) {
          O.update(() => {
      ...
      return s.isSync ? new _n(u) : new br(u);
    },
...
var Vr = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...An]),
  Hr = (e) => Array.isArray(e);
function Ur(e, t, n) {
  e.hasValue(t) ? e.getValue(t).set(n) : e.addValue(t, H(n));
}
function Wr(e) {
  return Hr(e) ? e[e.length - 1] || 0 : e;
}
function Gr(e, t) {
  let { transitionEnd: n = {}, transition: r = {}, ...i } = U(e, t) || {};
  i = { ...i, ...n };
  for (let t in i) Ur(e, t, Wr(i[t]));
}
...
var Yr = `data-` + Jr(`framerAppearId`);
function Xr(e) {
  return e.props[Yr];
}
function Zr({ protectedKeys: e, needsAnimating: t }, n) {
  let r = e.hasOwnProperty(n) && t[n] !== !0;
  return ((t[n] = !1), r);
}
function Qr(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(Fr(t, r, i, m && Vr.has(t) ? { type: !1 } : o, e, p));
    let h = r.animation;
    h && d.push(h);
  }
  if (o) {
...
function $r(e, t, n = {}) {
  let r = U(e, t, n.type === `exit` ? e.presenceContext?.custom : void 0),
...
function ei(e, t, n = 0, r = 0, i = 0, a = 1, o) {
  let s = [];
  for (let c of e.variantChildren)
    (c.notify(`AnimationStart`, t),
      s.push(
        $r(c, t, {
          ...o,
          delay: n + (typeof r == `function` ? 0 : r) + xr(e.variantChildren, c, r, i, a),
...
function ti(e, t, n = {}) {
  ...
  let r;
  if (Array.isArray(t)) {
    let i = t.map((t) => $r(e, t, n));
    r = Promise.all(i);
  } else if (typeof t == `string`) r = $r(e, t, n);
  else {
...
var ni = { test: (e) => e === `auto`, parse: (e) => e },
  ri = (e) => (t) => t.test(e),
  ii = [Ue, F, P, N, it, rt, ni],
  ai = (e) => ii.find(ri(e));
function oi(e) {
  return typeof e == `number` ? e === 0 : e === null || e === `none` || e === `0` || ne(e);
}
var si = new Set([`brightness`, `contrast`, `saturate`, `opacity`]);
function ci(e) {
...
var li = /\b([a-z-]*)\(.*?\)/gu,
  ...
  di = {
    ...
    getAnimatableNone: (e) => {
      let t = L.parse(e);
      return L.createTransformer(e)(
        t.map((e) => (typeof e == `number` ? 0 : typeof e == `object` ? { ...e, alpha: 1 } : e)),
      );
    },
  },
  fi = { ...Ue, transform: Math.round },
  pi = {
    borderWidth: F,
    borderTopWidth: F,
    borderRightWidth: F,
...
function _i(e, t) {
  let n = hi(e);
  return (gi.has(n) || (n = L), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
var vi = new Set([`auto`, `none`, `0`]);
function yi(e, t, n) {
  let r = 0,
    i;
  for (; r < e.length && !i;) {
    let t = e[r];
    (typeof t == `string` && !vi.has(t) && ht(t).values.length && (i = e[r]), r++);
  }
  if (i && n) for (let r of t) e[r] = _i(n, i);
}
var bi = class extends Un {
    ...
    readKeyframes() {
      ...
      if ((this.resolveNoneKeyframes(), !Vr.has(n) || e.length !== 2)) return;
      let [r, i] = e,
        a = ai(r),
        o = ai(i);
      if (He(r) !== He(i) && V[n]) {
      ...
      if (a !== o)
        ...
        else V[n] && (this.needsMeasurement = !0);
    }
    ...
    measureInitialState() {
      ...
      (n === `height` && (this.suspendedScrollY = window.pageYOffset),
        (this.measuredOrigin = V[n](e.measureViewportBox(), window.getComputedStyle(e.current))),
    ...
    measureEndState() {
      ...
      let i = n.length - 1,
        a = n[i];
      ((n[i] = V[t](e.measureViewportBox(), window.getComputedStyle(e.current))),
...
var Ci = (e, t) => (t && typeof e == `number` ? t.transform(e) : e);
function wi(e) {
  return te(e) && `offsetHeight` in e && !(`ownerSVGElement` in e);
}
var { schedule: Ti, cancel: Ei } = Ne(queueMicrotask, !1),
  G = { x: !1, y: !1 };
function Di() {
  return G.x || G.y;
}
...
var Mi = (e, t) => (t ? e === t || Mi(e, t.parentElement) : !1),
  Ni = (e) =>
    e.pointerType === `mouse` ? typeof e.button != `number` || e.button <= 0 : e.isPrimary !== !1,
  Pi = new Set([`BUTTON`, `INPUT`, `SELECT`, `TEXTAREA`, `A`]);
function Fi(e) {
  return Pi.has(e.tagName) || e.isContentEditable === !0;
}
var Ii = new Set([`INPUT`, `SELECT`, `TEXTAREA`]);
function Li(e) {
  return Ii.has(e.tagName) || e.isContentEditable === !0;
}
var Ri = new WeakSet();
function zi(e) {
  return (t) => {
...
function Wi(e, t, n = {}) {
  let [r, i, a] = ki(e, n),
    o = (e) => {
      ...
      if (!Hi(e) || Ui.has(e)) return;
      (Ri.add(r), n.stopPropagation && Ui.add(e));
      let a = t(r, e),
        o = { ...i, capture: !0 },
        s = (e, t) => {
          (window.removeEventListener(`pointerup`, c, o),
            window.removeEventListener(`pointercancel`, l, o),
            Ri.has(r) && Ri.delete(r),
            Hi(e) && typeof a == `function` && a(e, { success: t }));
        },
        c = (e) => {
          s(e, r === window || r === document || n.useGlobalTarget || Mi(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
  ...
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? window : e).addEventListener(`pointerdown`, o, i),
        wi(e) &&
          (e.addEventListener(`focus`, (e) => Vi(e, i)),
          !Fi(e) && !e.hasAttribute(`tabindex`) && (e.tabIndex = 0)));
    }),
    a
  );
}
...
var Ki = new WeakMap(),
  qi,
  Ji = (e, t, n) => (r, i) =>
    i && i[0] ? i[0][e + `Size`] : Gi(r) && `getBBox` in r ? r.getBBox()[t] : r[n],
  Yi = Ji(`inline`, `width`, `offsetWidth`),
  Xi = Ji(`block`, `height`, `offsetHeight`);
function Zi({ target: e, borderBoxSize: t }) {
  Ki.get(e)?.forEach((n) => {
    n(e, {
      get width() {
        return Yi(e, t);
...
function $i() {
  typeof ResizeObserver > `u` || (qi = new ResizeObserver(Qi));
}
function ea(e, t) {
  qi || $i();
  let n = Si(e);
  return (
    n.forEach((e) => {
      let n = Ki.get(e);
      (n || ((n = new Set()), Ki.set(e, n)), n.add(t), qi?.observe(e));
    }),
    () => {
      n.forEach((e) => {
        let n = Ki.get(e);
        (n?.delete(t), n?.size || qi?.unobserve(e));
      });
    }
  );
}
  ...
  return (
    ...
    () => {
      (ta.delete(e),
        !ta.size &&
          typeof na == `function` &&
          (window.removeEventListener(`resize`, na), (na = void 0)));
    }
  );
}
function aa(e, t) {
  return typeof e == `function` ? ia(e) : ea(e, t);
}
var oa = { value: null, addProjectionMetrics: null };
function sa(e) {
  return Gi(e) && e.tagName === `svg`;
}
var ca = [...ii, I, L],
  la = (e) => ca.find(ri(e)),
  ua = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
  da = () => ({ x: ua(), y: ua() }),
  fa = () => ({ min: 0, max: 0 }),
  K = () => ({ x: fa(), y: fa() }),
  pa = new WeakMap();
...
var ga = [`animate`, `whileInView`, `whileFocus`, `whileHover`, `whileTap`, `whileDrag`, `exit`],
  _a = [`initial`, ...ga];
function va(e) {
  return ma(e.animate) || _a.some((t) => ha(e[t]));
}
function ya(e) {
  ...
  for (let r in t) {
    ...
    if (W(i)) e.addValue(r, i);
      ...
      if (e.hasValue(r)) {
        ...
        e.addValue(r, H(t === void 0 ? i : t, { owner: e }));
      }
  }
...
var ka = class {
    ...
    constructor(
      ...
      ((this.latestValues = c),
        ...
        (this.isControllingVariants = va(t)),
        (this.isVariantNode = ya(t)),
        this.isVariantNode && (this.variantChildren = new Set()),
        (this.manuallyAnimateOnMount = !!(e && e.current)));
      let { willChange: u, ...d } = this.scrapeMotionValuesFromProps(t, {}, this);
      for (let e in d) {
        let t = d[e];
        c[e] !== void 0 && W(t) && t.set(c[e]);
      }
    }
    mount(e) {
      ...
      ((this.current = e),
        ...
        this.reducedMotionConfig === `never`
          ...
          : this.reducedMotionConfig === `always`
            ...
            : (Sa.current || wa(), (this.shouldReduceMotion = xa.current)),
    ...
    bindToMotionValue(e, t) {
      if (
        ...
        t.accelerate && pr.has(e) && this.current instanceof HTMLElement)
      ) {
    ...
    getValue(e, t) {
      ...
      return (
        n === void 0 &&
          t !== void 0 &&
          ((n = H(t === null ? void 0 : t, { owner: this })), this.addValue(e, n)),
        n
      );
    }
    readValue(e, t) {
      ...
      return (
        n != null &&
          (typeof n == `string` && (ee(n) || ne(n))
            ? (n = parseFloat(n))
            : !la(n) && L.test(t) && (n = _i(e, t)),
          this.setBaseTarget(e, W(n) ? n.get() : n)),
        W(n) ? n.get() : n
      );
    }
    setBaseTarget(e, t) {
    ...
    on(e, t) {
      return (this.events[e] || (this.events[e] = new oe()), this.events[e].add(t));
    }
    notify(e, ...t) {
      this.events[e] && this.events[e].notify(...t);
    }
    scheduleRenderMicrotask() {
      Ti.render(this.render);
    }
  },
  Aa = class extends ka {
    constructor() {
...
function J(e) {
  return Fa(e) || Ia(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY;
}
function Ia(e) {
  ...
  for (let s = 0; s < i; s++) {
    ...
    (i && i.props.style && i.props.style.display === `contents`) ||
      (r &&
        ...
        a.scroll &&
        a !== a.root &&
        (Y(e.x, -a.scroll.offset.x), Y(e.y, -a.scroll.offset.y)),
      o && ((t.x *= o.x.scale), (t.y *= o.y.scale), Va(e, o)),
      r && J(a.latestValues) && qa(e, a.latestValues, a.layout?.layoutBox));
  }
  (t.x < Ua && t.x > Ha && (t.x = 1), t.y < Ua && t.y > Ha && (t.y = 1));
}
function Y(e, t) {
  ((e.min += t), (e.max += t));
}
function Ga(e, t, n, r, i = 0.5) {
  Ba(e, t, n, R(e.min, e.max, i), r);
}
function Ka(e, t) {
...
function qa(e, t, n) {
  let r = n ?? e;
  (Ga(e.x, Ka(t.x, r.x), t.scaleX, t.scale, t.originX),
    Ga(e.y, Ka(t.y, r.y), t.scaleY, t.scale, t.originY));
}
function Ja(e, t) {
  return ja(Na(e.getBoundingClientRect(), t));
}
function Ya(e, t, n) {
  let r = Ja(e, n),
    { scroll: i } = t;
...
var Xa = { x: `translateX`, y: `translateY`, z: `translateZ`, transformPerspective: `perspective` },
  Za = An.length;
function Qa(e, t, n) {
  let r = ``,
    i = !0;
  ...
  return (
    a && ((i = !1), (r += `rotate(${Ci(a, pi.pathRotation)}) `)),
    (r = r.trim()),
...
function $a(e, t, n) {
  ...
  if (
    (t.transform || (o || n ? (r.transform = Qa(t, e.transform, n)) : (r.transform &&= `none`)), s)
  ) {
...
function ao(e, { layout: t, layoutId: n }) {
  return (
    jn.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!io[e] || e === `opacity`))
  );
}
function oo(e, t, n) {
  let r = e.style,
  ...
  if (!r) return a;
  for (let t in r)
    (W(r[t]) || (i && W(i[t])) || ao(t, e) || n?.getValue(t)?.liveStyle !== void 0) &&
      (a[t] = r[t]);
  return a;
}
function so(e) {
...
var co = class extends Aa {
    constructor() {
      (super(...arguments), (this.type = `html`), (this.renderInstance = eo));
    }
    readValueFromInstance(e, t) {
      if (jn.has(t)) return this.projection?.isProjecting ? En(t) : On(e, t);
      {
        let n = so(e),
          r = (Re(t) ? n.getPropertyValue(t) : n[t]) || 0;
  ...
  lo = { offset: `stroke-dashoffset`, array: `stroke-dasharray` },
  uo = { offset: `strokeDashoffset`, array: `strokeDasharray` };
function fo(e, t, n = 1, r = 0, i = !0) {
  e.pathLength = 1;
  let a = i ? lo : uo;
  ((e[a.offset] = `${-r}`), (e[a.array] = `${t} ${n}`));
}
var po = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`];
function mo(
  e,
...
function _o(e, t, n, r) {
  eo(e, t, void 0, r);
  for (let n in t.attrs) e.setAttribute(ho.has(n) ? n : Jr(n), t.attrs[n]);
}
function vo(e, t, n) {
  let r = oo(e, t, n);
  for (let n in e)
    if (W(e[n]) || W(t[n])) {
      let t = An.indexOf(n) === -1 ? n : `attr` + n.charAt(0).toUpperCase() + n.substring(1);
      r[t] = e[n];
    }
  return r;
}
var yo = class extends Aa {
    constructor() {
      (super(...arguments),
        (this.type = `svg`),
        (this.isSVGTag = !1),
    ...
    readValueFromInstance(e, t) {
      ...
      return ((t = ho.has(t) ? t : Jr(t)), e.getAttribute(t));
    }
    scrapeMotionValuesFromProps(e, t, n) {
      return vo(e, t, n);
    }
...
var Co = [...ga].reverse(),
  wo = ga.length;
function To(e) {
  return (t) => Promise.all(t.map(({ animation: t, options: n }) => ti(e, t, n)));
}
function Eo(e) {
  let t = To(e),
    n = Oo(),
  ...
  function s(o) {
    ...
    for (let t = 0; t < wo; t++) {
      ...
      if (
        ...
        (m.protectedKeys = { ...d }),
        (!m.isActive && _ === null) || (!h && !m.prevProp) || ma(h) || typeof h == `boolean`)
      )
        continue;
          ...
          ...S.map((t) => {
            ...
            if (typeof t == `string` && (r || i) && !ne && e.manuallyAnimateOnMount && e.parent) {
              ...
              if (r.enteringChildren && i) {
                ...
                n.delay = xr(r.enteringChildren, e, t);
              }
            }
...
function Io(e, t, n, r = 0.5) {
  ((e.origin = r),
    (e.originPoint = R(t.min, t.max, e.origin)),
    (e.scale = Q(n) / Q(t)),
    (e.translate = R(n.min, n.max, e.origin) - e.originPoint),
    ((e.scale >= jo && e.scale <= Mo) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= No && e.translate <= Po) || isNaN(e.translate)) && (e.translate = 0));
}
function Lo(e, t, n, r) {
  (Io(e.x, t.x, n.x, r ? r.originX : void 0), Io(e.y, t.y, n.y, r ? r.originY : void 0));
}
function Ro(e, t, n, r = 0) {
  ((e.min = (r ? R(n.min, n.max, r) : n.min) + t.min), (e.max = e.min + Q(t)));
}
function zo(e, t, n, r) {
  (Ro(e.x, t.x, n.x, r?.x), Ro(e.y, t.y, n.y, r?.y));
}
...
function Vo(e, t, n, r) {
  (Bo(e.x, t.x, n.x, r?.x), Bo(e.y, t.y, n.y, r?.y));
}
function Ho(e, t, n, r, i) {
  return ((e -= t), (e = Ra(e, 1 / n, r)), i !== void 0 && (e = Ra(e, 1 / i, r)), e);
}
function Uo(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  if (
    (P.test(t) && ((t = parseFloat(t)), (t = R(o.min, o.max, t / 100) - o.min)),
    typeof t != `number`)
  )
    return;
  let s = R(a.min, a.max, r);
  (e === a && (s -= t), (e.min = Ho(e.min, t, n, s, i)), (e.max = Ho(e.max, t, n, s, i)));
}
function Wo(e, t, [n, r, i], a, o) {
  Uo(e, t[n], t[r], t[i], t.scale, a, o);
}
var Go = [`x`, `scaleX`, `originX`],
  Ko = [`y`, `scaleY`, `originY`];
function qo(e, t, n, r) {
  (Wo(e.x, t, Go, n ? n.x : void 0, r ? r.x : void 0),
    Wo(e.y, t, Ko, n ? n.y : void 0, r ? r.y : void 0));
}
function Jo(e) {
...
var rs = xi.length,
  is = (e) => (typeof e == `string` ? parseFloat(e) : e),
  as = (e) => typeof e == `number` || F.test(e);
function os(e, t, n, r, i, a) {
  i
    ? ((e.opacity = R(0, n.opacity ?? 1, cs(r))), (e.opacityExit = R(t.opacity ?? 1, 0, ls(r))))
    : a && (e.opacity = R(t.opacity ?? 1, n.opacity ?? 1, r));
  for (let i = 0; i < rs; i++) {
    let a = xi[i],
      o = ss(t, a),
      s = ss(n, a);
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || as(o) === as(s)
        ? ((e[a] = Math.max(R(is(o), is(s), r), 0)), (P.test(s) || P.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
...
var cs = us(0, 0.5, be),
  ls = us(0.5, 0.95, T);
function us(e, t, n) {
  return (r) => (r < e ? 0 : r > t ? 1 : n(ae(e, t, r)));
}
function ds(e, t, n) {
  let r = W(e) ? e : H(e);
...
var _s = class {
    ...
    add(e) {
      ...
      for (let t = this.members.length - 1; t >= 0; t--) {
        ...
        let r = n.instance;
        (!r || r.isConnected === !1) && !n.snapshot && (x(this.members, n), n.unmount());
      }
      e.scheduleRender();
    }
    remove(e) {
      if ((x(this.members, e), e === this.prevLead && (this.prevLead = void 0), e === this.lead)) {
  ...
  ys = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 },
  bs = [``, `X`, `Y`, `Z`],
  xs = 1e3,
  Ss = 0;
function Cs(e, t, n, r) {
...
function Ts({
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Ss++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            oa.value && (ys.nodes = ys.calculatedTargetDeltas = ys.calculatedProjections = 0),
            this.nodes.forEach(Os),
            this.nodes.forEach(Ls),
            this.nodes.forEach(Rs),
            this.nodes.forEach(ks),
            oa.addProjectionMetrics && oa.addProjectionMetrics(ys));
        }),
    ...
    addEventListener(e, t) {
      return (
        this.eventHandlers.has(e) || this.eventHandlers.set(e, new oe()),
    ...
    mount(t) {
      ...
      ((this.isSVG = Gi(t) && !sa(t)), (this.instance = t));
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              vs.hasAnimatedSinceResize &&
                ((vs.hasAnimatedSinceResize = !1), this.nodes.forEach(Is)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              let a = this.options.transition || i.getDefaultTransition() || Gs,
                { onLayoutAnimationStart: o, onLayoutAnimationComplete: s } = i.getProps(),
                c = !this.targetLayout || !$o(this.targetLayout, r),
                l = !t && n;
              if (
    ...
    willUpdate(e = !0) {
      ...
      if (
        (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && ws(this),
    ...
    update() {
      ...
      ((this.animationCommitId = this.animationId),
        ...
        this.clearAllSnapshots());
      let e = j.now();
      ((A.delta = S(0, 1e3 / 60, e - A.timestamp)),
        (A.timestamp = e),
        (A.isProcessing = !0),
        Pe.update.process(A),
        Pe.preRender.process(A),
        Pe.render.process(A),
        (A.isProcessing = !1));
    }
    didUpdate() {
      this.updateScheduled || ((this.updateScheduled = !0), Ti.read(this.scheduleUpdate));
    }
    clearAllSnapshots() {
    ...
    scheduleUpdateProjection() {
      this.projectionUpdateScheduled ||
        ((this.projectionUpdateScheduled = !0), O.preRender(this.updateProjection, !1, !0));
    }
    ...
    resetTransform() {
      ...
      let e = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout,
        t = this.projectionDelta && !Yo(this.projectionDelta),
        n = this.getTransformTemplate(),
        r = n ? n(this.latestValues, ``) : void 0,
        a = r !== this.prevTransformTemplateValue;
      e &&
        this.instance &&
        (t || J(this.latestValues) || a) &&
    ...
    measurePageBox() {
      ...
      if (!(this.scroll?.wasRoot || this.path.some(Zs))) {
    ...
    removeElementScroll(e) {
      ...
      for (let n = 0; n < this.path.length; n++) {
        ...
        r !== this.root &&
          i &&
          a.layoutScroll &&
          (i.wasRoot && Z(t, e), Y(t.x, i.offset.x), Y(t.y, i.offset.y));
      }
      return t;
    }
    applyTransform(e, t = !1, n) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        (!t &&
          ...
          n.scroll &&
          n !== n.root &&
          (Y(r.x, -n.scroll.offset.x), Y(r.y, -n.scroll.offset.y)),
          J(n.latestValues) && qa(r, n.latestValues, n.layout?.layoutBox));
      }
      return (J(this.latestValues) && qa(r, this.latestValues, this.layout?.layoutBox), r);
    }
    removeTransform(e) {
      let t = K();
      Z(t, e);
      for (let e = 0; e < this.path.length; e++) {
        let n = this.path[e];
        if (!J(n.latestValues)) continue;
        let r;
        (n.instance &&
          (Fa(n.latestValues) && n.updateSnapshot(), (r = K()), Z(r, n.measurePageBox())),
          qo(t, n.latestValues, n.snapshot?.layoutBox, r));
      }
      return (J(this.latestValues) && qo(t, this.latestValues), t);
    }
    setTargetDelta(e) {
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          this.relativeParent.target
            ...
            : this.targetDelta
              ? (this.resumingFrom
                ...
                Va(this.target, this.targetDelta))
              : Z(this.target, this.layout.layoutBox),
          this.attemptToResolveRelativeTarget &&
          ...
          oa.value && ys.calculatedTargetDeltas++));
    }
    getClosestProjectingParent() {
      if (!(!this.parent || Fa(this.parent.latestValues) || Ia(this.parent.latestValues)))
    ...
    createRelativeTarget(e, t, n) {
      ((this.relativeParent = e),
        ...
        Vo(this.relativeTargetOrigin, t, n, this.options.layoutAnchor || void 0),
    ...
    calcProjection() {
      ...
      if (
        ...
        this.resolvedRelativeTargetAt === A.timestamp && (n = !1),
        n)
      )
        return;
      let { layout: r, layoutId: i } = this.options;
      ...
      let a = this.treeScale.x,
        o = this.treeScale.y;
      (Wa(this.layoutCorrected, this.treeScale, this.path, t),
        e.layout &&
          !e.target &&
          (this.treeScale.x !== 1 || this.treeScale.y !== 1) &&
          ((e.target = e.layout.layoutBox), (e.targetWithTransforms = K())));
      let { target: s } = e;
      if (!s) {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        oa.value && ys.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    createProjectionDeltas() {
      ((this.prevProjectionDelta = da()),
        (this.projectionDelta = da()),
        (this.projectionDeltaWithTransform = da()));
    }
    setAnimationOrigin(e, t = !1, n) {
      ...
      let s = K(),
        ...
        d = !!(c && !u && this.options.crossfade === !0 && !this.path.some(Ws));
      this.animationProgress = 0;
      let f,
      ...
      ((this.mixTargetDelta = (t) => {
        ...
        (r
          ...
          this.relativeTarget &&
            ...
            Us(this.relativeTarget, this.relativeTargetOrigin, s, n),
            f && Zo(this.relativeTarget, f) && (this.isProjectionDirty = !1),
            (f ||= K()),
            Z(f, this.relativeTarget)),
          c && ((this.animationValues = a), os(a, i, this.latestValues, n, d, u)),
          r &&
            r.rotate !== void 0 &&
    ...
    startAnimation(e) {
      (this.notifyListeners(`animationStart`),
        ...
        (this.pendingAnimation &&= (k(this.pendingAnimation), void 0)),
        (this.pendingAnimation = O.update(() => {
          ((vs.hasAnimatedSinceResize = !0),
            (this.motionValue ||= H(0)),
            this.motionValue.jump(0, !1),
            (this.currentAnimation = ds(this.motionValue, [0, 1e3], {
              ...e,
              velocity: 0,
              isSync: !0,
              onUpdate: (t) => {
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(xs), this.currentAnimation.stop()),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        if (
          ...
          this.layout &&
          r &&
          Xs(this.options.animationType, this.layout.layoutBox, r.layoutBox)
        ) {
          n = this.target || K();
        ...
        (Z(t, n), qa(t, i), Lo(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    registerSharedNode(e, t) {
      (this.sharedNodes.has(e) || this.sharedNodes.set(e, new _s()),
    ...
    resetSkewAndRotation() {
      ...
      if (
        ...
        return;
      let r = {};
      n.z && Cs(`z`, e, r, this.animationValues);
      for (let t = 0; t < bs.length; t++)
        (Cs(`rotate${bs[t]}`, e, r, this.animationValues),
          Cs(`skew${bs[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
    ...
    applyProjectionStyles(e, t) {
      ...
      let a = ns(this.projectionDeltaWithTransform, this.treeScale, i);
      ...
      for (let t in io) {
        ...
        let { correct: n, applyTo: o, isCSSVariable: s } = io[t],
...
function Ds(e) {
  ...
  if (e.isLead() && e.layout && t && e.hasListeners(`didUpdate`)) {
    ...
    Lo(o, n, t.layoutBox);
    let s = da();
    a ? Lo(s, e.applyTransform(r, !0), t.measuredBox) : Lo(s, n, t.layoutBox);
    let c = !Yo(o),
      l = !1;
    if (!e.resumeFrom) {
      ...
      if (r && !r.resumeFrom) {
        ...
        if (i && a) {
          let o = e.options.layoutAnchor || void 0,
            s = K();
          Vo(s, t.layoutBox, i.layoutBox, o);
          let c = K();
          (Vo(c, n, a.layoutBox, o),
            $o(s, c) || (l = !0),
...
function Xs(e, t, n) {
  return e === `position` || (e === `preserve-aspect` && !Fo(es(t), es(n), 0.2));
}
function Zs(e) {
...
var Qs = Ts({
  ...
  ec = Ts({
    ...
    defaultParent: () => {
      if (!$s.current) {
        let e = new Qs({});
        (e.mount(window), e.setOptions({ layoutScroll: !0 }), ($s.current = e));
      }
      return $s.current;
    },
    resetTransform: (e, t) => {
  ...
  tc = (0, o.createContext)({ transformPagePoint: (e) => e, isStatic: !1, reducedMotion: `never` });
function nc(e = !0) {
  ...
  let s = (0, o.useCallback)(() => e && r && r(a), [a, r, e]);
  return !n && r ? [!1, s] : [!0];
}
var rc = (0, o.createContext)({ strict: !1 }),
  ic = {
    animation: [
      `animate`,
      `variants`,
...
function oc() {
  if (ac) return;
  let e = {};
  for (let t in ic) e[t] = { isEnabled: (e) => ic[t].some((t) => !!e[t]) };
  (Da(e), (ac = !0));
}
function sc() {
  return (oc(), Oa());
...
var _c = (0, o.createContext)({});
function vc(e, t) {
  if (va(e)) {
    let { initial: t, animate: n } = e;
    return { initial: t === !1 || ha(t) ? t : void 0, animate: ha(n) ? n : void 0 };
  }
  return e.inherit === !1 ? {} : t;
}
function yc(e) {
  let { initial: t, animate: n } = vc(e, (0, o.useContext)(_c));
  return (0, o.useMemo)(() => ({ initial: t, animate: n }), [bc(t), bc(n)]);
}
function bc(e) {
  return Array.isArray(e) ? e.join(` `) : e;
}
var xc = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
function Sc(e, t, n) {
  for (let r in t) !W(t[r]) && !ao(r, n) && (e[r] = t[r]);
}
...
function wc(e, t) {
  let n = e.style || {},
    r = {};
  return (Sc(r, n, e), Object.assign(r, Cc(e, t)), r);
}
function Tc(e, t) {
  let n = {},
    r = wc(e, t);
...
function Dc(e, t, n, r) {
  let i = (0, o.useMemo)(() => {
    let n = Ec();
    return (mo(n, t, go(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
    (Sc(t, e.style, e), (i.style = { ...t, ...i.style }));
  }
  return i;
}
var Oc = [
...
function kc(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(Oc.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
function Ac(e, t, n, { latestValues: r }, i, a = !1, s) {
  let c = ((s ?? kc(e)) ? Dc : Tc)(t, r, i, e),
    l = gc(t, typeof e == `string`, a),
    u = e === o.Fragment ? {} : { ...l, ...c, ref: n },
    { children: d } = t,
    f = (0, o.useMemo)(() => (W(d) ? d.get() : d), [d]);
  return (0, o.createElement)(e, { ...u, children: f });
}
function jc({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, i) {
  return { latestValues: Mc(n, r, i, e), renderState: t() };
}
function Mc(e, t, n, r) {
  let i = {},
    a = r(e, {});
  for (let e in a) i[e] = gs(a[e]);
...
var Nc = (e) => (t, n) => {
    let r = (0, o.useContext)(_c),
      i = (0, o.useContext)(y),
      a = () => jc(e, t, r, i);
    return n ? a() : _(a);
  },
  Pc = Nc({ scrapeMotionValuesFromProps: oo, createRenderState: xc }),
  Fc = Nc({ scrapeMotionValuesFromProps: vo, createRenderState: Ec }),
...
var Rc = (0, o.createContext)({});
function zc(e) {
  return e && typeof e == `object` && Object.prototype.hasOwnProperty.call(e, `current`);
}
function Bc(e, t, n, r, i, a) {
  let { visualElement: s } = (0, o.useContext)(_c),
    c = (0, o.useContext)(rc),
    l = (0, o.useContext)(y),
    u = (0, o.useContext)(tc),
    d = u.reducedMotion,
  ...
  let h = p.current,
    g = (0, o.useContext)(Rc);
  h && !h.projection && i && (h.type === `html` || h.type === `svg`) && Vc(p.current, n, i, g);
  let _ = (0, o.useRef)(!1);
  (0, o.useInsertionEffect)(() => {
...
function Vc(e, t, n, r) {
  ...
  ((e.projection = new n(e.latestValues, t[`data-framer-portal-id`] ? void 0 : Hc(e.parent))),
    e.projection.setOptions({
      layoutId: i,
      layout: a,
      alwaysMeasureLayout: !!o || (s && zc(s)),
      visualElement: e,
...
function Hc(e) {
  if (e) return e.options.allowProjection === !1 ? Hc(e.parent) : e.projection;
}
function Uc(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  r && cc(r);
  let a = n ? n === `svg` : kc(e),
    s = a ? Fc : Pc;
  function c(n, c) {
    let l,
      u = { ...(0, o.useContext)(tc), ...n, layoutId: Wc(n) },
      { isStatic: d } = u,
      f = yc(n),
      p = s(n, d);
    if (!d && typeof window < `u`) {
      Gc(u, r);
      let t = Kc(u);
      ((l = t.MeasureLayout), (f.visualElement = Bc(e, p, u, i, t.ProjectionNode, a)));
    }
    return (0, h.jsxs)(_c.Provider, {
      value: f,
      children: [
        l && f.visualElement ? (0, h.jsx)(l, { visualElement: f.visualElement, ...u }) : null,
        Ac(e, n, Lc(p, f.visualElement, c), p, d, t, a),
      ],
    });
  }
...
function Wc({ layoutId: e }) {
  let t = (0, o.useContext)(g).id;
  return t && e !== void 0 ? t + `-` + e : e;
}
function Gc(e, t) {
  (0, o.useContext)(rc).strict;
}
function Kc(e) {
  let { drag: t, layout: n } = sc();
  if (!t && !n) return {};
  let r = { ...t, ...n };
  return {
...
function qc(e, t) {
  if (typeof Proxy > `u`) return Uc;
  let n = new Map(),
    r = (n, r) => Uc(n, r, e, t);
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) => (a === `create` ? r : (n.has(a) || n.set(a, Uc(a, void 0, e, t)), n.get(a))),
  });
}
var Jc = (e, t) =>
    (t.isSVG ?? kc(e)) ? new yo(t) : new co(t, { allowProjection: e !== o.Fragment }),
  Yc = class extends q {
    constructor(e) {
  ...
  Xc = 0,
  Zc = {
    animation: { Feature: Yc },
    exit: {
      Feature: class extends q {
        constructor() {
          (super(...arguments), (this.id = Xc++), (this.isExitComplete = !1));
        }
        update() {
...
var $c = (e) => (t) => Ni(t) && e(t, Qc(t));
function el(e, t, n, r) {
  return fs(e, t, $c(n), r);
}
var tl = ({ current: e }) => (e ? e.ownerDocument.defaultView : null),
  nl = (e, t) => Math.abs(e - t);
function rl(e, t) {
  let n = nl(e.x, t.x),
    r = nl(e.y, t.y);
...
var il = new Set([`auto`, `scroll`]),
  al = class {
    constructor(
      ...
      if (
        ...
        (this.updatePoint = () => {
          ...
          this.lastRawMoveEventInfo &&
            (this.lastMoveEventInfo = ol(this.lastRawMoveEventInfo, this.transformPagePoint));
          let e = cl(this.lastMoveEventInfo, this.history),
            t = this.startEvent !== null,
            n = rl(e.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
          if (!t && !n) return;
          let { point: r } = e,
            { timestamp: i } = A;
        ...
        (this.handlePointerMove = (e, t) => {
          ((this.lastMoveEvent = e),
            ...
            (this.lastMoveEventInfo = ol(t, this.transformPagePoint)),
        ...
        (this.handlePointerUp = (e, t) => {
          ...
          if (
            ...
            return;
          let a = cl(
            e.type === `pointercancel` ? this.lastMoveEventInfo : ol(t, this.transformPagePoint),
            this.history,
          );
      ...
      let s = ol(Qc(e), this.transformPagePoint),
        { point: c } = s,
        { timestamp: l } = A;
      this.history = [{ ...c, timestamp: l }];
      let { onSessionStart: u } = t;
      u && u(e, cl(s, this.history));
      let d = { passive: !0, capture: !0 };
      ((this.removeListeners = ie(
        el(this.contextWindow, `pointermove`, this.handlePointerMove, d),
        el(this.contextWindow, `pointerup`, this.handlePointerUp, d),
        el(this.contextWindow, `pointercancel`, this.handlePointerUp, d),
      )),
    ...
    startScrollTracking(e) {
      ...
      for (; t;) {
        ...
        ((il.has(e.overflowX) || il.has(e.overflowY)) &&
...
function cl({ point: e }, t) {
  return { point: e, delta: sl(e, ul(t)), offset: sl(e, ll(t)), velocity: dl(t, 0.1) };
}
function ll(e) {
  return e[0];
}
...
function fl(e, { min: t, max: n }, r) {
  return (
    t !== void 0 && e < t
      ? (e = r ? R(t, e, r.min) : Math.max(e, t))
      : n !== void 0 && e > n && (e = r ? R(n, e, r.max) : Math.min(e, n)),
    e
  );
}
function pl(e, t, n) {
...
function ml(e, { top: t, left: n, bottom: r, right: i }) {
  return { x: pl(e.x, n, i), y: pl(e.y, t, r) };
}
function hl(e, t) {
  let n = t.min - e.min,
    r = t.max - e.max;
...
function gl(e, t) {
  return { x: hl(e.x, t.x), y: hl(e.y, t.y) };
}
function _l(e, t) {
  let n = 0.5,
    r = Q(e),
    i = Q(t);
  return (
    i > r ? (n = ae(t.min, t.max - r, e.min)) : r > i && (n = ae(e.min, e.max - i, t.min)),
    S(0, 1, n)
  );
}
function vl(e, t) {
...
function bl(e = yl) {
  return (
    e === !1 ? (e = 0) : e === !0 && (e = yl),
    { x: xl(e, `left`, `right`), y: xl(e, `top`, `bottom`) }
  );
}
function xl(e, t, n) {
...
var Cl = new WeakMap(),
  wl = class {
    ...
    start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
      ...
      let i = (e) => {
          (t && this.snapToCursor(Qc(e).point), this.stopAnimation());
        },
        a = (e, t) => {
    ...
    updateAxis(e, t, n) {
      ...
      if (!n || !Dl(e, r, this.currentDirection)) return;
    ...
    resolveConstraints() {
      ...
      (e && zc(e)
        ...
        : e && n
          ? (this.constraints = ml(n.layoutBox, e))
          : (this.constraints = !1),
        (this.elastic = bl(t)),
        r !== this.constraints &&
          !zc(e) &&
    ...
    resolveRefConstraints() {
      ...
      let i = Ya(n, r.root, this.visualElement.getTransformPagePoint()),
        a = gl(r.layout.layoutBox, i);
      if (t) {
        let e = t(Ma(a));
        ((this.hasMutatedConstraints = !!e), e && (a = ja(e)));
      }
      return a;
    }
    startAnimation(e) {
      let {
        ...
        s = this.constraints || {},
        c = $((o) => {
          if (!Dl(o, t, this.currentDirection)) return;
          let c = (s && s[o]) || {};
    ...
    startAxisValueAnimation(e, t) {
      ...
      return (qr(this.visualElement, e), n.start(Fr(e, n, 0, t, this.visualElement, !1)));
    }
    stopAnimation() {
    ...
    snapToCursor(e) {
      $((t) => {
        ...
        if (!Dl(t, n, this.currentDirection)) return;
        let { projection: r } = this.visualElement,
          i = this.getAxisMotionValue(t);
        if (r && r.layout) {
          let { min: n, max: a } = r.layout.layoutBox[t],
            o = i.get() || 0;
          i.set(e[t] - R(n, a, 0.5) + o);
        }
      });
    }
    scalePositionWithinConstraints() {
      ...
      if (!zc(t) || !n || !this.constraints) return;
      this.stopAnimation();
      let r = { x: 0, y: 0 };
      $((e) => {
        ...
        if (t && this.constraints !== !1) {
          let n = t.get();
          r[e] = _l({ min: n, max: n }, this.constraints[e]);
        }
      });
      ...
      let e = this.visualElement.current,
        ...
        r = () => {
          ...
          zc(t) &&
            t.current &&
            ((this.constraints = this.resolveRefConstraints()),
            (n ||= El(e, t.current, () => this.scalePositionWithinConstraints())));
        },
        { projection: i } = this.visualElement,
        a = i.addEventListener(`measure`, r);
      (i && !i.layout && (i.root && i.root.updateScroll(), i.updateLayout()), O.read(r));
      let o = fs(window, `resize`, () => this.scalePositionWithinConstraints()),
...
var kl = class extends q {
  ...
  jl = class extends q {
    ...
    mount() {
      this.removePointerDownListener = el(this.node.current, `pointerdown`, (e) =>
...
function Pl(e) {
  ...
  return (0, h.jsx)(Nl, {
    ...e,
    layoutGroup: r,
    switchLayoutGroup: (0, o.useContext)(Rc),
    isPresent: t,
    safeToRemove: n,
  });
}
var Fl = { pan: { Feature: jl }, drag: { Feature: kl, ProjectionNode: ec, MeasureLayout: Pl } };
function Il(e, t, n) {
  let { props: r } = e;
  e.animationState && r.whileHover && e.animationState.setActive(`whileHover`, n === `Start`);
  let i = r[`onHover` + n];
  i && O.postRender(() => i(t, Qc(t)));
}
var Ll = class extends q {
    mount() {
      ...
      e &&
        (this.unmount = ji(
          e,
          (e, t) => (Il(this.node, t, `Start`), (e) => Il(this.node, e, `End`)),
        ));
    }
    unmount() {}
  },
...
var Bl = class extends q {
    mount() {
      ...
      this.unmount = Wi(
        e,
        (e, t) => (
          zl(this.node, t, `Start`),
          (e, { success: t }) => zl(this.node, e, t ? `End` : `Cancel`)
        ),
...
function Gl({ root: e, ...t }) {
  ...
  let r = Hl.get(n),
    i = JSON.stringify(t);
  return (r[i] || (r[i] = new IntersectionObserver(Wl, { root: e, ...t })), r[i]);
}
function Kl(e, t, n) {
  let r = Gl(t);
  return (
...
var ql = { some: 0, all: 1 },
  Jl = class extends q {
    ...
    startObserver() {
      ...
      this.stopObserver = Kl(this.node.current, a, o);
    }
    mount() {
      this.startObserver();
    }
    update() {
      ...
      [`amount`, `margin`, `root`].some(Yl(e, t)) && this.startObserver();
    }
    unmount() {
...
var Xl = {
  ...
  Zl = { layout: { ProjectionNode: ec, MeasureLayout: Pl } },
  Ql = qc({ ...Zc, ...Xl, ...Fl, ...Zl }, Jc);
export {
  v as C,
  m as E,
  y as S,
