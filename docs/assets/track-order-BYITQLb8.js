...
import { n as r } from "./store-D4zR_fkf.js";
import { E as i, t as a } from "./proxy-DkmRD95V.js";
import { t as o } from "./circle-alert-3YAmvEKb.js";
import { t as s } from "./circle-check-big-CefZxzci.js";
import { t as c } from "./truck-BLXXFY6c.js";
import { r as l } from "./products-pUvZdLaj.js";
import { i as u, l as d, r as f } from "./index-C7L7o5NO.js";
var p = i(`calendar`, [
  ...
  g = [
    ...
    { status: `Shipped`, label: `Shipped`, desc: `Dispatched to courier service hubs.` },
    {
...
function _() {
  let { orderId: e } = f.useSearch(),
    { orders: t } = r(),
    [n, i] = (0, m.useState)(``),
    [_, v] = (0, m.useState)(null),
    [y, b] = (0, m.useState)(!1);
  (0, m.useEffect)(() => {
    if (e) {
      i(e);
      let n = t.find((t) => t.id.toLowerCase() === e.toLowerCase());
      (v(n || null), b(!0));
    }
  }, [e, t]);
  let x = (e) => {
      if ((e.preventDefault(), C(!1), !n.trim())) return;
      let r = t.find((e) => e.id.toLowerCase() === n.trim().toLowerCase());
      (v(r || null), b(!0));
    },
    [S, C] = (0, m.useState)(!1),
    w = _
      ? ((e) => (e === `Payment Pending` ? 0 : g.findIndex((t) => t.status === e)))(_.status)
      : -1;
  return (0, h.jsxs)(`div`, {
      ...
      (0, h.jsxs)(`div`, {
        ...
        children: [
          (0, h.jsxs)(`div`, {
            ...
            children: [
              (0, h.jsx)(`p`, { className: `eyebrow`, children: `Dispatch Tracking` }),
              (0, h.jsx)(`h1`, {
            ...
            children: [
              (0, h.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, h.jsx)(d, {
                    className: `absolute left-3.5 top-3.5 h-4 w-4 text-muted-foreground`,
                  }),
                ],
              }),
              (0, h.jsx)(`button`, {
                          ...
                          (0, h.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, h.jsxs)(`p`, {
                                ...
                                children: [
                                  (0, h.jsx)(c, { className: `h-4 w-4 text-gold` }),
                                  ` `,
                                  _.shippingFee === 0 && _.paymentMethod.includes(`Pickup`)
                                    ? `Showroom Pick-Up`
                                    : `Speedaf Express / DHL`,
                                ],
                              }),
                            ...
                            children: g.map((e, t) => {
                              ...
                              return (0, h.jsxs)(
                                `div`,
                                {
                                  ...
                                  children: [
                                    (0, h.jsx)(`div`, {
                                      className: `absolute left-[-41px] top-0.5 h-6 w-6 rounded-full border flex items-center justify-center transition-all ${r ? `bg-gold text-white border-gold ring-4 ring-gold/15 scale-110` : n ? `bg-gold/10 text-gold border-gold` : `bg-card text-muted-foreground border-border`}`,
                                      children: n
                                        ? (0, h.jsx)(s, {
                                            className: `h-3.5 w-3.5 text-gold fill-current bg-white rounded-full`,
                                          })
                                        : (0, h.jsx)(`span`, {
                                    ...
                                    (0, h.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, h.jsx)(`h4`, {
                                          className: `text-xs font-semibold uppercase tracking-wider ${r ? `text-gold` : n ? `text-foreground` : `text-muted-foreground font-medium`}`,
                                          children: e.label,
                                        }),
                                        (0, h.jsx)(`p`, {
                                          className: `text-xs font-light leading-relaxed ${n ? `text-muted-foreground` : `text-muted-foreground/50`}`,
                                          children: e.desc,
                                        }),
                                      ],
                                    }),
                                ...
                                `div`,
                                {
                                  ...
                                  children: [
                                    ...
                                    (0, h.jsxs)(`span`, {
                                      ...
                                      children: [`GH₵ `, (e.price * l() * e.qty).toLocaleString()],
                                    }),
                                  ],
                                },
                                t,
                          ...
                          (0, h.jsxs)(`div`, {
                            ...
                            children: [
                              (0, h.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, h.jsx)(`span`, { children: `Shipping Digital Address` }),
                                  (0, h.jsx)(`span`, {
                                    className: `text-foreground uppercase`,
                                    children: _.shippingAddress.gpsAddress,
                                  }),
                                ],
                              }),
                              (0, h.jsxs)(`div`, {
                                className: `flex justify-between text-muted-foreground`,
                                children: [
                                  (0, h.jsx)(`span`, { children: `Street Landmark Location` }),
                                  (0, h.jsxs)(`span`, {
                                    className: `text-foreground`,
                                    children: [
                                      _.shippingAddress.streetAddress,
                                      `, `,
                                      _.shippingAddress.area || ``,
                                    ],
                                  }),
                                ],
                              }),
                              (0, h.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, h.jsx)(`span`, { children: `Transaction Total Charged` }),
                                  (0, h.jsxs)(`span`, {
                                    className: `text-gold`,
                                    children: [
                                      `GH₵`,
                                      ` `,
                                      (_.total * l()).toLocaleString(`en-US`, {
              ...
              y &&
                ...
                (0, h.jsxs)(
                  a.div,
                  {
                    ...
                    children: [
                      (0, h.jsx)(o, { className: `h-10 w-10 text-destructive mx-auto mb-3` }),
                      (0, h.jsx)(`h3`, {
