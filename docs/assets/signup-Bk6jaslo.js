...
function v() {
  ...
  let G = (e) => {
    ...
    q = async (r) => {
      ...
      if (C !== T) {
        B(`Passwords do not match. Please verify.`);
        return;
      }
      if (V < 2) {
        B(`Please choose a stronger password for security.`);
        return;
      }
      if (!j) {
        B(`You must accept the Terms and Conditions to proceed.`);
        return;
      }
      I(!0);
      try {
        let r = await t({ name: n, email: y, phone: x.replace(/\s+/g, ``), password: C });
        r.success
          ? (R(!0),
            setTimeout(() => {
              e({ to: `/dashboard` });
            }, 1500))
          : B(r.error || `Failed to create your account.`);
      } catch {
        B(`A server error occurred. Please try again later.`);
      } finally {
        I(!1);
      }
    },
    J = (e) => {
      (I(!0),
        ...
        setTimeout(() => {
          ...
          (n.some((e) => e.email === r.email) ||
            (n.push(r), localStorage.setItem(`naa-users-db`, JSON.stringify(n))),
            localStorage.setItem(`naa-user`, JSON.stringify(r)),
  ...
  return (0, _.jsxs)(`div`, {
    ...
    children: [
      (0, _.jsx)(`div`, {
        className: `absolute top-[-10%] left-[-10%] w-[45vw] h-[45vw] rounded-full bg-gold/5 blur-[120px] pointer-events-none`,
      }),
      (0, _.jsx)(`div`, {
        className: `absolute bottom-[-15%] right-[-10%] w-[45vw] h-[45vw] rounded-full bg-gold/5 blur-[140px] pointer-events-none`,
      }),
      (0, _.jsxs)(o.div, {
                    ...
                    (0, _.jsxs)(`div`, {
                      ...
                      children: [
                        (0, _.jsxs)(`span`, {
                          ...
                          children: [
                            (0, _.jsx)(m, { className: `h-3 w-3 text-gold` }),
                            ` Security Strength:`,
                          ],
                        }),
                        (0, _.jsx)(`span`, {
                          className: `font-semibold ${V >= 3 ? `text-gold` : `text-muted-foreground`}`,
                          children: U,
                        }),
                      ],
                    }),
                    (0, _.jsx)(`div`, {
                      ...
                      children: [1, 2, 3, 4].map((e) =>
                        (0, _.jsx)(
                          `div`,
                          {
                            className: `h-full flex-1 transition-colors duration-300 ${e <= V ? Y() : `bg-border/60`}`,
                          },
                          e,
                        ),
                      ),
