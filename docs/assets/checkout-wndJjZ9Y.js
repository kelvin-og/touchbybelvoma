...
import { t as ee } from "./useNavigate-OrW1W3oF.js";
import { n as te } from "./store-D4zR_fkf.js";
import { t as i } from "./proxy-DkmRD95V.js";
import { t as a } from "./arrow-left-AxtEw6TI.js";
import { t as o } from "./arrow-right-BmTjqXc8.js";
import { t as s } from "./circle-check-big-CefZxzci.js";
import { t as ne } from "./gift-BZ9vN9i8.js";
import { t as re } from "./lock-zNDHqqRP.js";
import { t as ie } from "./minus-BbksUQKY.js";
import { t as ae } from "./plus-DK9MZKQp.js";
import { t as oe } from "./rotate-ccw-CeOpUHCT.js";
import { t as se } from "./shield-alert-DsogB24J.js";
import { t as ce } from "./shield-check-D_i7EwFT.js";
import { t as le } from "./trash-2-CNqhW4qt.js";
import { i as ue, n as c, o as de, r as l } from "./products-pUvZdLaj.js";
import { c as fe, d as pe, i as u } from "./index-C7L7o5NO.js";
var d = t(e()),
  f = n(),
  me = [
    `Greater Accra`,
...
function he() {
  let e = ee(),
    {
      ...
      toggleWishlist: ye,
      addresses: p,
      createOrderFromCart: be,
    } = te(),
    [m, h] = (0, d.useState)(1),
    [g, xe] = (0, d.useState)([]),
    [_, Se] = (0, d.useState)(null),
    [v, Ce] = (0, d.useState)(``),
    [y, we] = (0, d.useState)(``),
    [b, x] = (0, d.useState)(``),
    [S, C] = (0, d.useState)(`+233`),
    [w, T] = (0, d.useState)(`Greater Accra`),
    [E, D] = (0, d.useState)(``),
    [O, k] = (0, d.useState)(``),
    [A, j] = (0, d.useState)(``),
    [M, N] = (0, d.useState)(``),
    [P, Te] = (0, d.useState)(``),
    [Ee, De] = (0, d.useState)(``),
    [Oe, ke] = (0, d.useState)(!0),
    [F, I] = (0, d.useState)(`standard`),
    [L, R] = (0, d.useState)(``),
    [z, Ae] = (0, d.useState)(``),
    [B, je] = (0, d.useState)(0),
    [Me, Ne] = (0, d.useState)(``),
    [V, H] = (0, d.useState)(`momo_mtn`),
    [U, Pe] = (0, d.useState)(``),
    [Fe, W] = (0, d.useState)(!1),
    [Ie, Le] = (0, d.useState)(``),
    [G, K] = (0, d.useState)(!1),
    [Re, ze] = (0, d.useState)(!1),
    [Be, q] = (0, d.useState)(``),
    [Ve, J] = (0, d.useState)(!1);
  if (
    ((0, d.useEffect)(() => {
      let e = t.map((e) => {
        let t = de.find((t) => t.id === e.productId);
        return {
          id: e.productId,
          name: t?.name || `Jewelry Piece`,
          price: t?.price || 0,
          qty: e.qty,
    ...
    return (0, f.jsxs)(`div`, {
      ...
      children: [
        (0, f.jsx)(fe, { className: `h-12 w-12 text-gold mb-4`, strokeWidth: 1.5 }),
        (0, f.jsx)(`h2`, {
        ...
        (0, f.jsx)(r, { to: `/shop`, className: `btn-gold mt-6`, children: `Explore Boutique` }),
      ],
    });
  let He = g.reduce((e, t) => e + t.price * t.qty, 0),
    Y = He * l(),
    X = Math.round((B / 100) * Y),
    Z = Y >= ue(),
    Q = (() => {
      if (Z || F === `pickup`) return 0;
      switch (F) {
        case `sameday`:
          return 60;
        case `nextday`:
      ...
      switch (F) {
        ...
        case `nextday`:
          return (
            ...
            e.toLocaleDateString(`en-US`, { weekday: `long`, month: `short`, day: `numeric` })
          );
        case `pickup`:
        ...
        default: {
          ...
          return (
            ...
            `${e.toLocaleDateString(`en-US`, { month: `short`, day: `numeric` })} - ${t.toLocaleDateString(`en-US`, { month: `short`, day: `numeric`, year: `numeric` })}`
          );
        }
      }
    },
    ...
    Ke = () => {
      _ && (_e(_.id, _.qty), Se(null));
    },
    qe = (e) => {
      (e.preventDefault(),
        Ne(``),
        L.toUpperCase().trim() === `TBBGIFT`
          ? (Ae(`TBBGIFT`), je(15), R(``))
          : L.toUpperCase().trim() === `BELVOMA10`
            ? (Ae(`BELVOMA10`), je(10), R(``))
            : Ne(`Invalid promotional coupon code.`));
    },
    Je = (e) => {
      let t = e.replace(/\s+/g, ``);
      if (!t.startsWith(`+233`)) return !1;
      let n = t.slice(4);
      if (n.length !== 9) return !1;
      let r = n.slice(0, 2);
      return [`24`, `54`, `55`, `59`, `53`, `20`, `50`, `26`, `56`, `27`, `57`].includes(r);
    },
    Ye = (e) => /^[A-Z]{2}-\d{3,4}-\d{4}$/.test(e.toUpperCase().trim()),
    Xe = () => {
      if ((q(``), m === 2)) {
        if (!v || !y || !b) {
          q(`Please fill out all required customer information.`);
          return;
        }
        if (!Je(S)) {
          q(`Please provide a valid Ghana phone number starting with +233.`);
          return;
        }
      }
      if (m === 3) {
        if (!E || !O || !A || !P) {
          q(`Please fill out all required delivery location details.`);
          return;
        }
        if (!Ye(A)) {
          q(`Invalid Ghana Post GPS format. Must be XX-XXX-XXXX (e.g. GA-182-9902).`);
          return;
        }
      }
      h(m + 1);
  ...
  return (0, f.jsxs)(`div`, {
    ...
    children: [
      (0, f.jsx)(`div`, {
        className: `absolute top-[-10%] left-[-10%] w-[35vw] h-[35vw] rounded-full bg-gold/5 blur-[120px] pointer-events-none`,
      }),
      (0, f.jsx)(`div`, {
        className: `absolute bottom-[-10%] right-[-10%] w-[35vw] h-[35vw] rounded-full bg-gold/5 blur-[120px] pointer-events-none`,
      }),
      (0, f.jsxs)(`div`, {
        ...
        children: [
          (0, f.jsxs)(`div`, {
            ...
            children: [
              (0, f.jsx)(`p`, { className: `eyebrow`, children: `Luxury Boutiques` }),
              (0, f.jsx)(`h1`, {
          ...
          (0, f.jsx)(`div`, {
            ...
            children: (0, f.jsxs)(`div`, {
              ...
              children: [
                (0, f.jsx)(`div`, {
                  className: `absolute top-[18px] left-[5%] right-[5%] h-[1.5px] bg-border z-0`,
                }),
                (0, f.jsx)(i.div, {
                  animate: { width: `${(m - 1) * 20}%` },
                ...
                [
                  ...
                  (0, f.jsxs)(
                    `button`,
                    {
                      ...
                      children: [
                        (0, f.jsx)(`div`, {
                          className: `h-9.5 w-9.5 rounded-full border flex items-center justify-center text-xs font-semibold transition-all ${m >= e.num ? `bg-gold text-white border-gold shadow-soft scale-105` : `bg-card text-muted-foreground border-border group-hover:border-gold/30`}`,
                          children:
                            m > e.num
                              ? (0, f.jsx)(s, { className: `h-4.5 w-4.5 text-white` })
                              : e.num,
                        }),
                        (0, f.jsx)(`span`, {
                          className: `text-[10px] uppercase tracking-wider mt-2 transition-colors ${m >= e.num ? `text-foreground font-semibold` : `text-muted-foreground font-light`}`,
                          children: e.name,
                        }),
                      ],
                    },
          ...
          (0, f.jsx)(u, {
            children:
              ...
              (0, f.jsxs)(i.div, {
                ...
                children: [
                  (0, f.jsx)(se, { className: `h-5 w-5 text-destructive shrink-0` }),
                  (0, f.jsx)(`span`, {
                            ...
                            (0, f.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, f.jsxs)(`span`, {
                                  ...
                                  children: [g.length, ` unique pieces`],
                                }),
                              ],
                            }),
                            _ &&
                              (0, f.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, f.jsxs)(`span`, {
                                    ...
                                    children: [
                                      (0, f.jsx)(le, { className: `h-4 w-4 text-gold` }),
                                      ` Item removed from checkout bag.`,
                                    ],
                                  }),
                                  (0, f.jsxs)(`button`, {
                                    onClick: Ke,
                                    ...
                                    children: [
                                      (0, f.jsx)(oe, { className: `h-3.5 w-3.5` }),
                                      ` Undo`,
                                    ],
                                  }),
                                ],
                                          ...
                                          (0, f.jsxs)(`div`, {
                                            ...
                                            children: [
                                              (0, f.jsx)(`button`, {
                                                ...
                                                children: (0, f.jsx)(pe, {
                                                  className: `h-4 w-4 ${ve.includes(e.id) ? `fill-gold text-gold` : ``}`,
                                                }),
                                              }),
                                              (0, f.jsx)(`button`, {
                                                onClick: () => Ge(e.id, e.qty),
                                                ...
                                                children: (0, f.jsx)(le, { className: `h-4 w-4` }),
                                              }),
                                            ],
                                          }),
                                        ],
                            ...
                            (0, f.jsxs)(`div`, {
                              ...
                              children: [
                                (0, f.jsxs)(`h3`, {
                                  ...
                                  children: [
                                    (0, f.jsx)(ne, { className: `h-4 w-4` }),
                                    ` Apply Promotional Campaign Coupon`,
                                  ],
                                }),
                                (0, f.jsxs)(`form`, {
                                  onSubmit: qe,
                                ...
                                z &&
                                  (0, f.jsxs)(`p`, {
                                    ...
                                    children: [
                                      (0, f.jsx)(s, { className: `h-3.5 w-3.5 text-green-600` }),
                                      ` Coupon "`,
                                      z,
                                      `" verified (`,
                                      B,
                            ...
                            (0, f.jsxs)(`div`, {
                              ...
                              children: [
                                (0, f.jsxs)(r, {
                                  ...
                                  children: [
                                    (0, f.jsx)(a, { className: `h-3.5 w-3.5` }),
                                    ` Return to Boutique`,
                                  ],
                                }),
                                (0, f.jsxs)(`button`, {
                              ...
                              children: (0, f.jsxs)(`label`, {
                                ...
                                children: [
                                  (0, f.jsx)(`input`, {
                                    type: `checkbox`,
                                    checked: Oe,
                                    onChange: (e) => ke(e.target.checked),
                        ...
                        i.div,
                        {
                          ...
                          children: [
                            ...
                            (0, f.jsxs)(`div`, {
                              ...
                              children: [
                                (0, f.jsxs)(`label`, {
                                  className: `p-4 border rounded-xl flex items-center justify-between cursor-pointer transition-all ${w === `Greater Accra` ? (F === `sameday` ? `border-gold bg-gold/5` : `border-border hover:border-gold/30`) : `opacity-55 cursor-not-allowed border-border`}`,
                                  children: [
                                    (0, f.jsxs)(`div`, {
                                    ...
                                    (0, f.jsx)(`span`, {
                                      ...
                                      children: Z ? `FREE` : `GH₵ 60.00`,
                                    }),
                                  ],
                                }),
                                (0, f.jsxs)(`label`, {
                                  className: `p-4 border rounded-xl flex items-center justify-between cursor-pointer transition-all ${F === `nextday` ? `border-gold bg-gold/5` : `border-border hover:border-gold/30`}`,
                                  children: [
                                    (0, f.jsxs)(`div`, {
                                      className: `flex items-start gap-3`,
                                      children: [
                                    ...
                                    (0, f.jsx)(`span`, {
                                      className: `text-xs font-semibold text-gold`,
                                      children: Z ? `FREE` : `GH₵ 45.00`,
                                    }),
                                  ],
                                }),
                                (0, f.jsxs)(`label`, {
                                  className: `p-4 border rounded-xl flex items-center justify-between cursor-pointer transition-all ${F === `standard` ? `border-gold bg-gold/5` : `border-border hover:border-gold/30`}`,
                                  children: [
                                    (0, f.jsxs)(`div`, {
                                      className: `flex items-start gap-3`,
                                      children: [
                                    ...
                                    (0, f.jsx)(`span`, {
                                      className: `text-xs font-semibold text-gold`,
                                      children: Z ? `FREE` : `GH₵ 30.00`,
                                    }),
                                  ],
                                }),
                                (0, f.jsxs)(`label`, {
                                  className: `p-4 border rounded-xl flex items-center justify-between cursor-pointer transition-all ${F === `pickup` ? `border-gold bg-gold/5` : `border-border hover:border-gold/30`}`,
                                  children: [
                                    (0, f.jsxs)(`div`, {
                                      className: `flex items-start gap-3`,
                                      children: [
                            ...
                            (0, f.jsxs)(`div`, {
                              ...
                              children: [
                                (0, f.jsx)(`button`, {
                                  ...
                                  className: `py-3 text-[10px] font-semibold uppercase tracking-wider rounded-xl border transition-all ${V === `momo_mtn` ? `border-gold bg-gold/5 text-gold` : `border-border text-muted-foreground hover:bg-accent/10`}`,
                                  children: `MTN MoMo`,
                                }),
                                (0, f.jsx)(`button`, {
                                  onClick: () => {
                                  ...
                                  className: `py-3 text-[10px] font-semibold uppercase tracking-wider rounded-xl border transition-all ${V === `momo_telecel` ? `border-gold bg-gold/5 text-gold` : `border-border text-muted-foreground hover:bg-accent/10`}`,
                                ...
                                (0, f.jsx)(`button`, {
                                  ...
                                  className: `py-3 text-[10px] font-semibold uppercase tracking-wider rounded-xl border transition-all ${V === `card_paystack` ? `border-gold bg-gold/5 text-gold` : `border-border text-muted-foreground hover:bg-accent/10`}`,
                                ...
                                (0, f.jsx)(`button`, {
                                  ...
                                  className: `py-3 text-[10px] font-semibold uppercase tracking-wider rounded-xl border transition-all ${V === `bank_transfer` ? `border-gold bg-gold/5 text-gold` : `border-border text-muted-foreground hover:bg-accent/10`}`,
                                  children: `Bank Transfer`,
                                }),
                              ],
                            }),
                            (V === `momo_mtn` || V === `momo_telecel`) &&
                              (0, f.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, f.jsxs)(`h3`, {
                                    ...
                                    children: [
                                      V === `momo_mtn` ? `MTN Mobile Money` : `Telecel Cash`,
                                      ` Gateway`,
                                    ],
                                  }),
                                  (0, f.jsx)(`p`, {
                                    ...
                                    : (0, f.jsxs)(`form`, {
                                        onSubmit: (e) => {
                                          if ((e.preventDefault(), q(``), !U)) {
                                            q(`Please enter your Mobile Money account number.`);
                                            return;
                                          }
                                          (K(!0),
                                            setTimeout(() => {
                            ...
                            (0, f.jsxs)(`div`, {
                              ...
                              children: [
                                (0, f.jsxs)(`span`, {
                                  ...
                                  children: [
                                    (0, f.jsx)(re, { className: `h-3.5 w-3.5 text-gold` }),
                                    ` SSL Encrypted`,
                                  ],
                                }),
                                (0, f.jsxs)(`span`, {
                                  className: `text-[10px] font-semibold text-muted-foreground tracking-widest uppercase flex items-center gap-1`,
                                  children: [
                                    (0, f.jsx)(ce, { className: `h-4 w-4 text-gold` }),
                                    ` PCI Compliant`,
                                  ],
                                }),
                              ],
                              ...
                              children: [
                                (0, f.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, f.jsxs)(`p`, { children: [v, ` `, y] }),
                                    (0, f.jsx)(`p`, { children: b }),
                                    (0, f.jsx)(`p`, { children: S }),
                                  ],
                                }),
                                (0, f.jsxs)(`div`, {
                                  className: `p-4 border border-border rounded-xl space-y-1`,
                                  children: [
                                    ...
                                    (0, f.jsxs)(`p`, { children: [P, `, `, O, `, `, E] }),
                                    (0, f.jsxs)(`p`, { children: [w, ` Region, Ghana`] }),
                                    (0, f.jsxs)(`p`, {
                                      className: `font-semibold text-foreground uppercase mt-1`,
                                      children: [`GPS Digital: `, A],
                                    }),
                                    M &&
                                      (0, f.jsxs)(`p`, {
                                        className: `text-muted-foreground`,
                              ...
                              children: (0, f.jsxs)(`label`, {
                                ...
                                children: [
                                  (0, f.jsx)(`input`, {
                                    type: `checkbox`,
                                    checked: Re,
                                    onChange: (e) => ze(e.target.checked),
                                    className: `w-3.5 h-3.5 border-border rounded text-gold focus:ring-gold bg-transparent cursor-pointer mt-0.5`,
                                  }),
                                  (0, f.jsxs)(`span`, {
                                    className: `text-muted-foreground group-hover:text-foreground transition-colors`,
                                ...
                                (0, f.jsx)(`button`, {
                                  ...
                                  children: Ve
                                    ...
                                    : (0, f.jsxs)(f.Fragment, {
                                        children: [
                                          `Finalize Order `,
                                          (0, f.jsx)(re, { className: `h-3.5 w-3.5` }),
                                        ],
                                      }),
                                }),
                              ],
              ...
              (0, f.jsxs)(`div`, {
                ...
                children: [
                      ...
                      (0, f.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, f.jsx)(`span`, {
                            className: `font-semibold text-foreground`,
                            children:
                              F === `pickup` ? `Free` : Z ? `FREE (Offer)` : `GH₵ ${Q.toFixed(2)}`,
                          }),
                        ],
                      }),
                      z &&
                        (0, f.jsxs)(`div`, {
                          ...
                          children: [
                            (0, f.jsxs)(`span`, { children: [`Coupon Discount (`, B, `%)`] }),
                            (0, f.jsxs)(`span`, { children: [`-GH₵ `, X.toFixed(2)] }),
                          ],
                        }),
                      (0, f.jsxs)(`div`, {
                        className: `flex justify-between border-t border-border pt-3 text-sm font-semibold`,
                        children: [
                          (0, f.jsx)(`span`, { children: `Grand Total (GHS)` }),
                          (0, f.jsxs)(`span`, {
                            className: `text-gold font-bold`,
                            children: [
                              `GH₵`,
                              ` `,
                              Ue.toLocaleString(`en-US`, { minimumFractionDigits: 2 }),
                            ],
                          }),
                        ],
                      }),
                  ...
                  (0, f.jsxs)(`div`, {
                    ...
                    children: [
                      (0, f.jsx)(ne, { className: `h-4 w-4 text-gold shrink-0 mt-0.5` }),
                      (0, f.jsxs)(`span`, {
                        children: [
                          `Free shipping applied on orders above GH₵`,
                          ` `,
                          ue().toLocaleString(`en-US`),
                          `. Apply coupon`,
                          ` `,
                          (0, f.jsx)(`strong`, { children: `TBBGIFT` }),
