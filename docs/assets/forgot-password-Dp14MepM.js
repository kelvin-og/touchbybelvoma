...
import { t as c } from "./key-llr-Cbit.js";
import { t as l } from "./mail-D2A7KeaU.js";
import { t as u } from "./shield-alert-DsogB24J.js";
import { i as d } from "./index-BLNfkPy1.js";
var f = t(e()),
  p = n();
function m() {
  ...
  let D = async (e) => {
      (e.preventDefault(),
        ...
        setTimeout(() => {
          S(!1);
          let e = localStorage.getItem(`naa-users-db`);
          if (!(
            (e ? JSON.parse(e) : []).some((e) => e.email.toLowerCase() === n.toLowerCase()) ||
            n.toLowerCase() === `luxury@belvoma.com`
          )) {
            b(`This email address is not registered in our records.`);
            return;
          }
          t(2);
        }, 1e3));
    ...
    O = async (e) => {
      if ((e.preventDefault(), b(``), h !== _)) {
        b(`Passwords do not match.`);
        return;
      }
      if (C < 2) {
        b(`Password is too weak. Please add uppercase letters, numbers, or symbols.`);
        return;
      }
      (S(!0),
        setTimeout(() => {
          ...
          if (e) {
            let t = JSON.parse(e),
              r = t.findIndex((e) => e.email.toLowerCase() === n.toLowerCase());
            r !== -1 &&
              ((t[r].passwordHash = `hash_` + Math.abs(h.length).toString(16)),
              localStorage.setItem(`naa-users-db`, JSON.stringify(t)));
          }
          t(4);
        }, 1200));
    },
  ...
  return (0, p.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, p.jsx)(`div`, {
        className: `absolute bottom-[-15%] left-[-10%] w-[45vw] h-[45vw] rounded-full bg-gold/5 blur-[145px] pointer-events-none`,
      }),
      (0, p.jsxs)(i.div, {
        ...
        children: [
          ...
          y &&
            (0, p.jsxs)(`div`, {
              ...
              children: [
                (0, p.jsx)(u, { className: `h-4.5 w-4.5 text-destructive shrink-0 mt-0.5` }),
                (0, p.jsx)(`span`, {
                    ...
                    children: [
                      ...
                      (0, p.jsxs)(`form`, {
                        ...
                        children: [
                          ...
                          (0, p.jsxs)(`button`, {
                            ...
                            children: [
                              x ? `Transmitting...` : `Send Reset Token`,
                              !x && (0, p.jsx)(o, { className: `h-3.5 w-3.5` }),
                            ],
                          }),
                        ],
                      }),
                      (0, p.jsx)(`div`, {
                        ...
                        children: (0, p.jsxs)(r, {
                          ...
                          children: [
                            (0, p.jsx)(a, { className: `h-3.5 w-3.5` }),
                            ` Back to Sign In`,
                          ],
                        }),
                      }),
                  ...
                  i.div,
                  {
                    ...
                    children: [
                      (0, p.jsx)(`div`, {
                        ...
                        children: (0, p.jsx)(l, { className: `h-6 w-6` }),
                      }),
                      (0, p.jsx)(`h2`, {
                      ...
                      (0, p.jsxs)(`div`, {
                        ...
                        children: [
                          (0, p.jsxs)(`p`, {
                            ...
                            children: [
                              (0, p.jsx)(s, { className: `h-3.5 w-3.5 text-gold` }),
                              ` Simulation Mode`,
                            ],
                          }),
                          (0, p.jsx)(`p`, {
                      ...
                      (0, p.jsxs)(`button`, {
                        ...
                        children: [
                          ...
                          (0, p.jsx)(o, { className: `h-3.5 w-3.5` }),
                        ],
                      }),
                      (0, p.jsx)(`button`, {
                        type: `button`,
                      ...
                      (0, p.jsxs)(`form`, {
                        ...
                        children: [
                                ...
                                (0, p.jsx)(`div`, {
                                  ...
                                  children: [1, 2, 3, 4].map((e) =>
                                    (0, p.jsx)(
                                      `div`,
                                      {
                                        className: `h-full flex-1 transition-colors duration-300 ${e <= C ? k() : `bg-border/60`}`,
                                      },
                                      e,
                                    ),
                                  ),
                          ...
                          (0, p.jsxs)(`button`, {
                            ...
                            className: `w-full py-3.5 px-6 rounded-xl font-button text-xs font-semibold tracking-[0.2em] text-white uppercase bg-gradient-to-r from-gold to-gold-light hover:brightness-105 transition-all shadow-soft flex items-center justify-center gap-2`,
                            children: [
                              x ? `Saving Credentials...` : `Update Password`,
                              !x && (0, p.jsx)(c, { className: `h-3.5 w-3.5` }),
                            ],
                          }),
                        ],
                      }),
                ...
                (0, p.jsxs)(
                  i.div,
                  {
                    ...
                    children: [
                      (0, p.jsx)(`div`, {
                        className: `mx-auto w-12 h-12 rounded-full bg-gold/10 flex items-center justify-center text-gold mb-4`,
                        children: (0, p.jsx)(s, { className: `h-6 w-6` }),
                      }),
                      (0, p.jsx)(`h2`, {
                        className: `text-xl font-semibold text-foreground`,
                      ...
                      (0, p.jsx)(`div`, {
                        ...
                        children: (0, p.jsxs)(r, {
                          ...
                          children: [`Sign In `, (0, p.jsx)(o, { className: `h-3.5 w-3.5` })],
                        }),
                      }),
                    ],
                  },
