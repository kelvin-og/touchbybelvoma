import { a as e } from "./jsx-runtime-D8nDyRPw.js";
var t = `/assets/cat-earrings-CS8_5WnP.jpg`,
  n = `/assets/cat-necklaces-CA35ESkp.jpg`,
  r = `/assets/cat-rings-nwp7hGcZ.jpg`,
  i = `/assets/cat-bracelets-Ddznn2Mk.jpg`,
  a = `/assets/cat-anklets-BvOqvkqX.jpg`,
  o = `/assets/cat-sets-TzrZ12TK.jpg`,
  s = `/assets/prod-hoops-C6vI0mpG.jpg`,
  c = `/assets/prod-pearl-studs-CgMQZG8m.jpg`,
  l = `/assets/prod-layered-necklace-CuIfWTjk.jpg`,
  u = `/assets/prod-choker-Bno77IGw.jpg`,
  d = `/assets/prod-signet-ring-C1y1igCU.jpg`,
  f = `/assets/prod-baguette-ring-BiPlhGgy.jpg`,
  p = `/assets/prod-tennis-bracelet-BcCZOvMg.jpg`,
  m = `/assets/prod-cuff-CAS_Upcn.jpg`,
  h = e({
    categories: () => g,
    formatPrice: () => x,
    getCediMultiplier: () => y,
    getFreeShippingThreshold: () => b,
    getProduct: () => v,
    products: () => _,
  }),
  g = [
    { slug: `earrings`, name: `Earrings`, image: t },
    { slug: `necklaces`, name: `Necklaces`, image: n },
    { slug: `rings`, name: `Rings`, image: r },
    { slug: `bracelets`, name: `Bracelets`, image: i },
    { slug: `anklets`, name: `Anklets`, image: a },
    { slug: `sets`, name: `Sets`, image: o },
  ],
  _ = [
    {
      id: `aurelia-hoops`,
  ...
  y = () => {
    if (typeof window < `u`) {
      let e = window.localStorage.getItem(`tbb_config_cedi_multiplier`);
      if (e) {
        let t = parseFloat(e);
  ...
  b = () => {
    if (typeof window < `u`) {
      let e = window.localStorage.getItem(`tbb_config_free_shipping`);
      if (e) {
        let t = parseInt(e);
        if (!isNaN(t) && t >= 0) return t;
      }
  ...
  x = (e) =>
    `GH₵ ${(e * y()).toLocaleString(`en-US`, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
export { v as a, b as i, x as n, _ as o, y as r, h as s, g as t };
