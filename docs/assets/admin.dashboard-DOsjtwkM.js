...
import { t as r } from "./useNavigate-OrW1W3oF.js";
import { n as i } from "./store-D4zR_fkf.js";
import { E as a, t as o } from "./proxy-DkmRD95V.js";
import { n as s, t as ee } from "./log-out-CaZYO5lF.js";
import { t as te } from "./circle-check-big-CefZxzci.js";
import { n as c, r as l, t as u } from "./users-B-qtsgpQ.js";
import { t as d } from "./plus-DK9MZKQp.js";
import { t as f } from "./shield-alert-DsogB24J.js";
import { t as p } from "./trash-2-CNqhW4qt.js";
import { n as m, o as h, r as g } from "./products-pUvZdLaj.js";
import { c as _, i as v } from "./index-BLNfkPy1.js";
var y = a(`percent`, [
...
function S() {
  let e = r(),
    { user: t, logout: n, orders: a, updateOrderStatus: S } = i(),
    [C, w] = (0, b.useState)(`analytics`),
    [T, E] = (0, b.useState)([]),
    D = a,
    [O, k] = (0, b.useState)([]),
    [A, j] = (0, b.useState)([]),
  ...
  if (
    ((0, b.useEffect)(() => {
      let e = localStorage.getItem(`tbb_admin_products`);
      if (e) E(JSON.parse(e));
      else {
        let e = h.map((e) => ({
          id: e.id,
          ...
          price: e.price,
          category: e.category,
          stock: e.id.includes(`hoops`) || e.id.includes(`studs`) ? 8 : 45,
        }));
        (E(e), localStorage.setItem(`tbb_admin_products`, JSON.stringify(e)));
      }
      let t = localStorage.getItem(`tbb_admin_promos`);
      if (t) k(JSON.parse(t));
      else {
        let e = [
        ...
        (k(e), localStorage.setItem(`tbb_admin_promos`, JSON.stringify(e)));
      }
      let n = localStorage.getItem(`naa-users-db`);
      j(n ? JSON.parse(n) : []);
    }, []),
    (0, b.useEffect)(() => {
      if (!t || t.role !== `admin`) {
  ...
  let q = (e) => {
      if ((e.preventDefault(), !M || !P || !L)) return;
      let t = [
        {
      ...
      (E(t),
        localStorage.setItem(`tbb_admin_products`, JSON.stringify(t)),
        N(``),
        F(``),
        R(`25`),
        B(!0),
    ...
    J = (e, t) => {
      let n = T.map((n) => (n.id === e ? { ...n, stock: Math.max(0, t) } : n));
      (E(n), localStorage.setItem(`tbb_admin_products`, JSON.stringify(n)));
    },
    Y = (e) => {
      if ((e.preventDefault(), !V || !U)) return;
      let t = [{ code: V.toUpperCase().trim(), discount: parseInt(U), status: `Active` }, ...O];
      (k(t),
        localStorage.setItem(`tbb_admin_promos`, JSON.stringify(t)),
        H(``),
        W(``),
        K(!0),
        setTimeout(() => K(!1), 3e3));
    ...
    X = (e) => {
      let t = O.filter((t) => t.code !== e);
      (k(t), localStorage.setItem(`tbb_admin_promos`, JSON.stringify(t)));
    },
    re = (e, t) => {
      S(e, t);
    },
    Z = D.reduce((e, t) => e + t.total, 0) * g(),
    Q = D.length,
    ie = Q > 0 ? Z / Q : 0,
    $ = {
      ...
      children: [
        (0, x.jsxs)(`div`, {
          ...
          children: [
            (0, x.jsxs)(`div`, {
              children: [
                (0, x.jsx)(`p`, { className: `eyebrow`, children: `Executive Panel` }),
                (0, x.jsx)(`h1`, {
                ...
                (0, x.jsxs)(`p`, {
                  ...
                  children: [
                    `Logged in as `,
                    (0, x.jsx)(`span`, { className: `font-semibold`, children: t.name }),
            ...
            (0, x.jsxs)(`button`, {
              ...
              children: [(0, x.jsx)(ee, { className: `h-4 w-4` }), ` End Admin Session`],
            }),
          ],
        }),
        (0, x.jsxs)(`div`, {
          ...
          children: [
            (0, x.jsxs)(`nav`, {
              ...
              children: [
                (0, x.jsxs)(`button`, {
                  onClick: () => w(`analytics`),
                  className: `flex items-center gap-3 px-4 py-3 text-xs tracking-wider uppercase font-medium rounded-xl transition-all whitespace-nowrap ${C === `analytics` ? `bg-charcoal text-white font-semibold shadow-soft` : `text-muted-foreground hover:text-foreground`}`,
                  children: [(0, x.jsx)(c, { className: `h-4 w-4 text-gold` }), ` Sales Analytics`],
                }),
                (0, x.jsxs)(`button`, {
                  onClick: () => w(`products`),
                  className: `flex items-center gap-3 px-4 py-3 text-xs tracking-wider uppercase font-medium rounded-xl transition-all whitespace-nowrap ${C === `products` ? `bg-charcoal text-white font-semibold shadow-soft` : `text-muted-foreground hover:text-foreground`}`,
                  children: [(0, x.jsx)(l, { className: `h-4 w-4 text-gold` }), ` Product Catalog`],
                }),
                (0, x.jsxs)(`button`, {
                  onClick: () => w(`inventory`),
                  className: `flex items-center gap-3 px-4 py-3 text-xs tracking-wider uppercase font-medium rounded-xl transition-all whitespace-nowrap ${C === `inventory` ? `bg-charcoal text-white font-semibold shadow-soft` : `text-muted-foreground hover:text-foreground`}`,
                  children: [
                    (0, x.jsx)(f, { className: `h-4 w-4 text-gold` }),
                    ` Stock & Inventory`,
                  ],
                }),
                (0, x.jsxs)(`button`, {
                  onClick: () => w(`orders`),
                  className: `flex items-center gap-3 px-4 py-3 text-xs tracking-wider uppercase font-medium rounded-xl transition-all whitespace-nowrap ${C === `orders` ? `bg-charcoal text-white font-semibold shadow-soft` : `text-muted-foreground hover:text-foreground`}`,
                  children: [
                    (0, x.jsx)(_, { className: `h-4 w-4 text-gold` }),
                    ` Processing Orders`,
                  ],
                }),
                (0, x.jsxs)(`button`, {
                  onClick: () => w(`customers`),
                  className: `flex items-center gap-3 px-4 py-3 text-xs tracking-wider uppercase font-medium rounded-xl transition-all whitespace-nowrap ${C === `customers` ? `bg-charcoal text-white font-semibold shadow-soft` : `text-muted-foreground hover:text-foreground`}`,
                  children: [
                    (0, x.jsx)(u, { className: `h-4 w-4 text-gold` }),
                    ` Customer Registry`,
                  ],
                }),
                (0, x.jsxs)(`button`, {
                  onClick: () => w(`promos`),
                  className: `flex items-center gap-3 px-4 py-3 text-xs tracking-wider uppercase font-medium rounded-xl transition-all whitespace-nowrap ${C === `promos` ? `bg-charcoal text-white font-semibold shadow-soft` : `text-muted-foreground hover:text-foreground`}`,
                  children: [
                    (0, x.jsx)(y, { className: `h-4 w-4 text-gold` }),
                    ` Discounts & Promos`,
                  ],
                }),
              ],
                                ...
                                children: [
                                  ...
                                  (0, x.jsxs)(`h3`, {
                                    ...
                                    children: [
                                      `GH₵`,
                                      ` `,
                                      ie.toLocaleString(`en-US`, { maximumFractionDigits: 0 }),
                                    ],
                                  }),
                                  (0, x.jsx)(`p`, {
                                    className: `text-[10px] text-muted-foreground mt-2 font-light`,
                          ...
                          (0, x.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, x.jsx)(`div`, {
                                ...
                                children: [15, 30, 45, 25, 60, 80, 95].map((e, t) =>
                                  (0, x.jsxs)(
                                    `div`,
                                    {
                                      ...
                                      children: [
                                        (0, x.jsx)(o.div, {
                                          initial: { height: 0 },
                                          animate: { height: `${e}%` },
                                          transition: { duration: 0.8, delay: t * 0.05 },
                                          ...
                                          children: (0, x.jsxs)(`span`, {
                                            ...
                                            children: [`GH₵ `, (e * 100 * g()).toLocaleString()],
                                          }),
                                        }),
                                        (0, x.jsx)(`span`, {
                          ...
                          (0, x.jsx)(v, {
                            children:
                              ...
                              (0, x.jsxs)(o.div, {
                                ...
                                children: [
                                  (0, x.jsx)(te, { className: `h-4.5 w-4.5 text-green-600` }),
                                    ...
                                    children: [
                                      ...
                                      (0, x.jsxs)(`select`, {
                                        ...
                                        children: [
                                          ...
                                          (0, x.jsx)(`option`, { value: `sets`, children: `Sets` }),
                                        ],
                                      }),
                                    ],
                                  }),
                              ...
                              children: [
                                (0, x.jsx)(`thead`, {
                                  children: (0, x.jsxs)(`tr`, {
                                    ...
                                    children: [
                                      (0, x.jsx)(`th`, { className: `p-4`, children: `Name` }),
                                      (0, x.jsx)(`th`, { className: `p-4`, children: `Category` }),
                                      (0, x.jsx)(`th`, {
                                        className: `p-4`,
                                        children: `Base Price`,
                                      }),
                                      ...
                                      (0, x.jsx)(`th`, { className: `p-4`, children: `Stock` }),
                                    ],
                                  }),
                                }),
                                (0, x.jsx)(`tbody`, {
                                    ...
                                    (0, x.jsxs)(
                                      `tr`,
                                      {
                                        ...
                                        children: [
                                          ...
                                          (0, x.jsxs)(`td`, {
                                            className: `p-4 font-semibold ${e.stock < 10 ? `text-red-500 font-bold` : `text-foreground`}`,
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            (0, x.jsxs)(`div`, {
                                              children: [
                                                ...
                                                (0, x.jsx)(`span`, {
                                                  className: `inline-block text-[9px] font-semibold uppercase tracking-widest mt-0.5 px-2.5 py-0.5 rounded-full ${e.status === `Delivered` ? `bg-green-50 text-green-700 border border-green-100` : `bg-gold/10 text-gold border border-gold/20`}`,
                                                  children: e.status,
                                                }),
                                              ],
                                            }),
                                        ...
                                        (0, x.jsxs)(`div`, {
                                          ...
                                          children: [
                                            ...
                                            (0, x.jsxs)(`select`, {
                                              value: e.status,
                                              onChange: (t) => re(e.id, t.target.value),
                                ...
                                (0, x.jsx)(`thead`, {
                                  children: (0, x.jsxs)(`tr`, {
                                    ...
                                    children: [
                                      ...
                                      (0, x.jsx)(`th`, { className: `p-4`, children: `Email` }),
                                      (0, x.jsx)(`th`, {
                                        className: `p-4`,
                                        children: `Ghana Phone`,
                                      }),
                                      (0, x.jsx)(`th`, { className: `p-4`, children: `Role` }),
                                      (0, x.jsx)(`th`, {
                                        className: `p-4`,
                                        ...
                                        children: [
                                          ...
                                          (0, x.jsx)(`td`, {
                                            ...
                                            children: (0, x.jsx)(`span`, {
                                              className: `inline-block text-[9px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full ${e.role === `admin` ? `bg-purple-100 text-purple-700` : `bg-gold/10 text-gold`}`,
                                              children: e.role,
                                            }),
                                          }),
                                          (0, x.jsx)(`td`, {
                        ...
                        children: [
                          ...
                          G &&
                            (0, x.jsxs)(`div`, {
                              ...
                              children: [
                                (0, x.jsx)(s, { className: `h-4 w-4` }),
                                ` Promotional discount code generated successfully.`,
                              ],
                            }),
                          (0, x.jsxs)(`form`, {
                            onSubmit: Y,
                                        ...
                                        children: [
                                          ...
                                          (0, x.jsx)(`td`, {
                                            ...
                                            children: (0, x.jsx)(`button`, {
                                              ...
                                              children: (0, x.jsx)(p, { className: `h-4 w-4` }),
                                            }),
                                          }),
                                        ],
                                      },
