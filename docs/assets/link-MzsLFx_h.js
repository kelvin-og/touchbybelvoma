...
import { t as i } from "./useRouter-Crv3SibY.js";
var a = t((t) => {
    var n = e();
    function r(e) {
...
function f(e) {
  for (let t in e) if (u.call(e, t)) return !0;
  return !1;
}
...
function g(e) {
  ...
  for (let n of t) if (!d.call(e, n)) return !1;
...
function b(e, t, n) {
  ...
  if (Array.isArray(e) && Array.isArray(t)) {
    ...
    for (let r = 0, i = e.length; r < i; r++) if (!b(e[r], t[r], n)) return !1;
    return !0;
  }
  if (_(e) && _(t)) {
    let r = n?.ignoreUndefined ?? !0;
    if (n?.partial) {
      for (let i in t) if ((!r || t[i] !== void 0) && !b(e[i], t[i], n)) return !1;
      return !0;
    }
    let i = 0;
    ...
    let a = 0;
    for (let o in t) if ((!r || t[o] !== void 0) && (a++, a > i || !b(e[o], t[o], n))) return !1;
    return i === a;
  }
  return !1;
}
...
var w = /[\x00-\x1f\x7f"<>`{}]/g;
function T(e) {
  return e.replace(w, (e) => `%` + e.charCodeAt(0).toString(16).toUpperCase().padStart(2, `0`));
}
function E(e) {
  let t;
  try {
...
function ne(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    r = ``,
    i;
  for (; (i = t.exec(e)) !== null;) ((r += E(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += E(n ? e.slice(n) : e);
  let a = !1;
  return (
...
function M(e, t, n, r, i, a, o) {
  ...
  let s = r;
  {
      ...
      switch (((s = d + 1), a++, e[0])) {
        ...
        case 1: {
          ...
          if (h) o = h;
            ...
            let e = I(1, n.fullPath ?? n.from, f, p, m);
        ...
        case 3: {
          ...
          if (h) o = h;
            ...
            let e = I(3, n.fullPath ?? n.from, f, p, m);
    ...
    if (u && r.endsWith(`/`)) {
      let e = F(n.fullPath ?? n.from);
      ((e.kind = j), (e.parent = i), a++, (e.depth = a), (i.index = e), (i = e));
    }
    ((i.parse = l ?? null),
      (i.priority = n.options?.params?.priority ?? 0),
      u && !i.route && ((i.route = n), (i.fullPath = n.fullPath ?? n.from)));
  }
  if (n.children) for (let r of n.children) M(e, t, r, s, i, a, o);
}
function N(e, t) {
...
function le(e, t) {
  let n = F(`/`),
    r = new Uint16Array(6);
  for (let t of e) M(!1, r, t, 1, n, 0);
  (P(n), (t.masksTree = n), (t.flatCache = A(1e3)));
}
function ue(e, t) {
  e ||= `/`;
  let n = t.flatCache.get(e);
  if (n) return n;
  let r = V(e, t.masksTree);
...
function L(e, t, n, r, i) {
  ...
  return (
    o || ((o = F(`/`)), M(t, new Uint16Array(6), { from: e }, 1, o, 0), i.singleCache.set(a, o)),
    V(r, o, n)
  );
}
function R(e, t, n = !1) {
  ...
  let a;
  try {
    a = V(e, t.segmentTree, n);
  } catch (e) {
    if (e instanceof URIError) a = null;
    else throw e;
  }
  return (a && (a.branch = U(a.route)), t.matchCache.set(r, a), a);
}
function z(e) {
...
function B(e, t = !1, n) {
  ...
  return (
    M(t, i, e, 1, r, 0, (e) => {
      if ((n?.(e, s), e.id in a && ae(), (a[e.id] = e), s !== 0 && e.path)) {
        let t = z(e.fullPath);
...
function fe(e, t, n, r) {
  ...
  let i = !s(t),
    a = i && e !== `/`,
    o = t.length - +!!i,
    c = [{ node: n, index: 1, skipped: 0, depth: 1, statics: 0, dynamics: 0, optionals: 0 }],
    l = null,
    u = null;
  for (; c.length;) {
    let n = c.pop(),
      { node: i, index: s, skipped: d, depth: f, statics: p, dynamics: m, optionals: h } = n,
      { extract: g, rawParams: _ } = n;
    if (i.kind === 2 && i.route && !q(u, n)) continue;
    if (i.parse) {
      if (!K(e, t, n)) continue;
      ((_ = n.rawParams), (g = n.extract));
    }
    r && i.route && i.kind !== j && q(l, n) && (l = n);
    let v = s === o;
    if (
      v &&
      (i.route && (!a || i.kind === j || i.kind === 2) && q(u, n) && (u = n),
    ...
    if (v && i.index) {
      let n = {
        ...
        r = !0;
      if ((i.index.parse && (K(e, t, n) || (r = !1)), r)) {
        if (!m && !h && !d && G(p, o)) return n;
        q(u, n) && (u = n);
      }
    }
    if (i.wildcard)
      for (let e = i.wildcard.length - 1; e >= 0; e--) {
        ...
        if (!(r && (v || !(n.caseSensitive ? y : (b ??= y.toLowerCase())).startsWith(r)))) {
          if (a) {
            if (v) continue;
            let e = t.slice(s).join(`/`).slice(-a.length);
      ...
      (t.dynamics > e.dynamics ||
        (t.dynamics === e.dynamics &&
          (t.optionals > e.optionals ||
            (t.optionals === e.optionals &&
              ((t.node.kind === j) > (e.node.kind === j) ||
                ((t.node.kind === j) == (e.node.kind === j) && t.depth > e.depth)))))))
  );
}
function pe(e) {
  return J(e.filter((e) => e !== void 0).join(`/`));
}
function J(e) {
...
function _e({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  let i = t.startsWith(`/`),
    a = !i && t === `.`,
    o;
  if (r) {
  ...
  if (a) c = e.split(`/`);
    ...
    for (c = e.split(`/`); c.length > 1 && s(c) === ``;) c.pop();
    let n = t.split(`/`);
  ...
  c.length > 1 && (s(c) === `` ? n === `never` && c.pop() : n === `always` && c.push(``));
  let l = J(c.join(`/`)) || `/`;
...
function be({ path: e, params: t, decoder: n, ...r }) {
  let i = !1,
    a = Object.create(null);
...
var Se = `Error preloading route! ☝️`,
  Z = n(e(), 1),
  Ce = Z.use,
  we = typeof window < `u` ? Z.useLayoutEffect : Z.useEffect;
function Te(e) {
...
var Oe = r();
function ke({ children: e, fallback: t = null }) {
  return Ae() ? (0, Oe.jsx)(Z.Fragment, { children: e }) : (0, Oe.jsx)(Z.Fragment, { children: t });
}
function Ae() {
...
function Le(e, t, n = Ie) {
  ...
  return (0, Fe.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
var Re = o();
function ze(e, t) {
  let n = i(),
    ...
    I = Z.useMemo(() => {
      let e = { _fromLocation: F, ...P };
      return n.buildLocation(e);
    }, [n, F, P]),
    le = I.maskedLocation ? I.maskedLocation.publicHref : I.publicHref,
    ue = I.maskedLocation ? I.maskedLocation.external : I.external,
    L = Z.useMemo(() => Ke(le, ue, n.history, x), [x, ue, le, n.history]),
    R = Z.useMemo(() => {
      if (L?.external) return ee(L.href, n.protocolAllowlist) ? void 0 : L.href;
      if (!qe(c) && !(typeof c != `string` || c.indexOf(`:`) === -1))
        try {
          return (new URL(c), ee(c, n.protocolAllowlist) ? void 0 : c);
        } catch {}
    }, [c, L, n.protocolAllowlist]),
    z = Z.useMemo(() => {
      if (R) return !1;
      if (s?.exact) {
        if (!ge(F.pathname, I.pathname, n.basepath)) return !1;
      } else {
        let e = X(F.pathname, n.basepath),
          t = X(I.pathname, n.basepath);
        if (!(e.startsWith(t) && (e.length === t.length || e[t.length] === `/`))) return !1;
      }
      return (s?.includeSearch ?? !0) &&
        !b(F.search, I.search, { partial: !s?.exact, ignoreUndefined: !s?.explicitUndefined })
        ? !1
        : !s?.includeHash || (N && F.hash === I.hash);
    }, [
      s?.exact,
      s?.explicitUndefined,
      s?.includeHash,
    ...
    B = z ? (l(a, {}) ?? Ve) : Be,
    V = z ? Be : (l(o, {}) ?? Be),
    H = [C, B.className, V.className].filter(Boolean).join(` `),
    U = (S || B.style || V.style) && { ...S, ...B.style, ...V.style },
    [de, fe] = Z.useState(!1),
    W = Z.useRef(!1),
    G = e.reloadDocument || R ? !1 : (u ?? n.options.defaultPreload),
    K = d ?? n.options.defaultPreloadDelay ?? 0,
    q = Z.useCallback(() => {
      n.preloadRoute({ ...P, _builtLocation: I }).catch((e) => {
        (console.warn(e), console.warn(Se));
      });
    }, [n, P, I]);
  (Ee(
    r,
    ...
    Ge,
    { disabled: !!x || G !== `viewport` },
  ),
    Z.useEffect(() => {
      W.current || (!x && G === `render` && (q(), (W.current = !0)));
    }, [x, q, G]));
  let pe = (e) => {
    let t = e.currentTarget.getAttribute(`target`),
      r = y === void 0 ? t : y;
    if (!x && !Ye(e) && !e.defaultPrevented && (!r || r === `_self`) && e.button === 0) {
      (e.preventDefault(),
        (0, Re.flushSync)(() => {
          fe(!0);
        }));
...
var Be = {},
  Ve = { className: `active` },
  He = { role: `link`, "aria-disabled": !0 },
  Ue = { "data-status": `active`, "aria-current": `page` },
  We = { "data-transitioning": `transitioning` },
  Q = new WeakMap(),
  Ge = { rootMargin: `100px` },
  $ = (e) => (t) => {
    for (let n of e)
